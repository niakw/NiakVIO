...
/* FIXDATA:PROVIDER.COFLIX.CONFIG.V1:_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🎥 Coflix","domainSubstitutions":{"coflix.blog":"coflix.group","coflix.blue":"coflix.group","coflix.boston":"coflix.group","coflix.cymru":"coflix.group","coflix.esq":"coflix.group","coflix.fr":"coflix.group","coflix.life":"coflix.group","coflix.to":"coflix.group","coflix.wiki":"coflix.group"},"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://coflix.group","modelSchemaVersion":4,"observedUrls":["https://coflix.group"],"officialApi":null,"officialHub":"https://coflix.domains/","officialSite":"https://coflix.group","origins":["https://coflix.group","https://coflix.domains"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"coflix","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/?s={query}","/film/{slug}/"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"mixed_embed_resolver","strictHtmlIdentity":true,"strictIdentity":false,"supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:3daaeaa8ad0d */
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:7de5c7f40f8d */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"coflix","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-shared-tmdb-cache-native-zero-extra-fetch-v17-jvm-json-utf8"});
