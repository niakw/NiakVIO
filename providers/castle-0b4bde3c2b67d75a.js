...
/* FIXDATA:PROVIDER.CASTLE.CONFIG.V1:__Y2xpZW50VHlwZT0xJnBhY2thZ2VOYW1lPWNvbS5leHRlcm5hbC5jYXN0bGUmY2hhbm5lbD1JbmRpYUEmbGFuZz1lbi1VUyIsIi9maWxtLWFwaS92MS45LjkvbW92aWU_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🏰 Castle","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://api.hlowb.com","modelSchemaVersion":4,"observedUrls":["https://api.hlowb.com/","https://api.hlowb.com"],"officialApi":"https://api.hlowb.com","officialHub":null,"officialSite":"https://api.hlowb.com","origins":["https://api.hlowb.com"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"castle","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/v0.1/system/getSecurityKey/1?channel=IndiaA&clientType=1&lang=en-US","/film-api/v1.1.0/movie/searchByKeyword?channel=IndiaA&clientType=1&keyword={query}&lang=en-US&mode=1&packageName=com.external.castle&page=1&size=30","/film-api/v1.9.9/movie?channel=IndiaA&clientType=1&lang=en-US&movieId={id}&packageName=com.external.castle","/film-api/v2.0.1/movie/getVideo2?clientType=1&packageName=com.external.castle&channel=IndiaA&lang=en-US","/film-api/v1.9.9/movie?channel=","/film-api/v1.1.0/movie/searchByKeyword","/film-api/v2.0.1/movie/getVideo2?clientType=","/api.hlowb.com"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"unknown","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":true,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4:eyJjYXBhYmlsaXR5U3RyYXRlZ3kiOiJhcGlfc3RyZWFtX3Jlc29sdmVyIiwiY29sbGlzaW9uRml4dHVyZXMiOnsiMjU5NTQ0Ijp7ImFsaWFzZXMiOlsiSGVsbCBUZWFjaGVyOiBKaWdva3UgU2Vuc2VpIE51YmUiLCJKaWdva3UgU2Vuc2VpIE51YmUiLCJIZWxsIFRlYWNoZXIgTnViZSIsIuWcsOeNhOWFiOeUn-OBrO-9nuOBue- */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:f63b0668efc8 */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10bWRiLWNhY2hlLWxhenktZXBpc29kZS12NyIsInByb3ZpZGVySWQiOiJjYXN0bGUiLCJ0bWRiUnVudGltZUtleVJlcXVpcmVkIjp0cnVlLCJ0bWRiVGltZW91dE1zIjoxMjAwfQ== */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:36e1c057486d */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"castle","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-cache-lazy-episode-v7"});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:413e6b2939ae */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"castle","providerLanguageMode":"vo","languageFallback":"VO","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY2IiwicHJvdmlkZXJFbW9qaSI6IvCfj7AiLCJwcm92aWRlcklkIjoiY2FzdGxlIiwicHJvdmlkZXJOYW1lIjoiQ2FzdGxlIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:a72a49264033 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"castle","providerName":"Castle","providerEmoji":"🏰","implementationRevision":"post-presentation-name-title-quality-v6"});
