...
/* FIXDATA:PROVIDER.NAKIOS.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🇳 Nakios","domainSubstitutions":{"api.nakios.store":"api.nakios.live","nakios.store":"nakios.live"},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://nakios.store","modelSchemaVersion":4,"observedUrls":["https://nakios.store/","https://api.nakios.store/","https://nakios.store","https://api.nakios.store"],"officialApi":"https://api.nakios.store","officialHub":"https://nakios.org/","officialSite":"https://nakios.store","origins":["https://nakios.store","https://nakios.org","https://api.nakios.store","https://nakios.live","https://api.nakios.live"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"nakios","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api/sources/movie/{id}","/api/sources/tv/{id}/{season}/{episode}","/api/search/multi","/search-fallback.js","/resolvers.js","/api/sources/movie/550","/api/search/multi?query={query","/api/sources/movie/{id","/api/sources/tv/{id}/{season}/{episode","/api/sources/movie/{tmdbId","/api/sources/tv/{tmdbId}/{season}/{episode","/api/search/multi?query={query}","/api/sources/movie/{tmdbId}","/api/sources/tv/{tmdbId}/{season}/{episode}"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"tmdb-direct-api","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:cde225e486ba */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"nakios","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
