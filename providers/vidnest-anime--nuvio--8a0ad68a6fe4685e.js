...
/* FIXDATA:PROVIDER.VIDNEST-ANIME.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🪺 VidnestAnime","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://vidnest.fun","modelSchemaVersion":4,"observedUrls":["https://backend.vidnest.fun/","https://vidnest.fun/","https://aesdec.nuvioapp.space/decrypt","https://vidnest.fun","https://backend.vidnest.fun"],"officialApi":"https://backend.vidnest.fun","officialHub":null,"officialSite":"https://vidnest.fun","origins":["https://vidnest.fun","https://backend.vidnest.fun","https://aesdec.nuvioapp.space","https://api.ani.zip"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"vidnest-anime","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/animeworld/{id}/{episode}/server/my%20server","/satoru/{id}/{episode}","/aniwave/{id}/{episode}/{media}/wave","/aniwave/{id}/{episode}/{media}/pahe","/aniwave/{id}/{episode}/{media}/anya","/animeworld/{id}/server/my%20server","/streams"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"tmdb-direct-api","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoidmlkbmVzdC1hbmltZSIsInRtZGJSdW50aW1lS2V5UmVxdWlyZWQiOnRydWUsInRtZGJUaW1lb3V0TXMiOjEyMDB9 */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:6e56fc4e93d6 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vidnest-anime","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfqroiLCJwcm92aWRlcklkIjoidmlkbmVzdC1hbmltZSIsInByb3ZpZGVyTmFtZSI6IlZpZG5lc3RBbmltZSJ9 */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:76bbd8bc9a7a */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vidnest-anime","providerName":"VidnestAnime","providerEmoji":"🪺","implementationRevision":"post-presentation-name-title-quality-v7"});
