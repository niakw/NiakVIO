...
/* FIXDATA:PROVIDER.KURAGE.CONFIG.V1:_dG1kYklkPXt0bWRiSWR9JnR5cGU9dHYmc2Vhc29uPXtzZWFzb259JmVwaXNvZGU9e2VwaXNvZGV9IiwiL2FwaS92MiIsIi9hcGkvdHJwYy9jYXRhbG9nLmFuaWxpc3RJbmZvLGVwaXNvZGVzLnNvdXJjZSxlcGlzb2Rlcy5zb3VyY2U_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🪼 Kurage","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://kurage.live","modelSchemaVersion":4,"observedUrls":["https://kurage.live/","https://kurage.live"],"officialApi":null,"officialHub":null,"officialSite":"https://kurage.live","origins":["https://kurage.live"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"kurage","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/?tmdbId={tmdbId}&type=tv&season={season}&episode={episode}","/api/v2","/api/trpc/catalog.anilistInfo,episodes.source,episodes.source?batch=1&input="],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"catalogue-html","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoia3VyYWdlIiwidG1kYlJ1bnRpbWVLZXlSZXF1aXJlZCI6dHJ1ZSwidG1kYlRpbWVvdXRNcyI6MTIwMH0= */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:d0aa55063353 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"kurage","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfqrwiLCJwcm92aWRlcklkIjoia3VyYWdlIiwicHJvdmlkZXJOYW1lIjoiS3VyYWdlIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:e07f26ce1209 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"kurage","providerName":"Kurage","providerEmoji":"🪼","implementationRevision":"post-presentation-name-title-quality-v7"});
