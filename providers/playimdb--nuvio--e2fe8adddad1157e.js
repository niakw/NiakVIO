...
/* FIXDATA:PROVIDER.PLAYIMDB.CONFIG.V1:eyJhcGlSZWNpcGUiOm51bGwsImF1dGhvcmluZyI6Im5pYWt2aW8tb3duZWQtdjMiLCJkaXNwbGF5TmFtZSI6IuKWtu-_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"▶️ PlayIMDb","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://nextgencloudfabric.com","modelSchemaVersion":4,"observedUrls":["https://streamdata.vaplayer.ru/api.php","https://nextgencloudfabric.com/","https://nextgencloudfabric.com","https://streamdata.vaplayer.ru"],"officialApi":"https://streamdata.vaplayer.ru","officialHub":null,"officialSite":"https://nextgencloudfabric.com","origins":["https://nextgencloudfabric.com","https://streamdata.vaplayer.ru"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"playimdb","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api.php?tmdb={id}&type={media}","/api.php?tmdb={id}&type={media}&season={season}&episode={episode}","/api.php","/episode/","/streamdata.vaplayer.ru/api.php"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"tmdb-direct-api","strategy":"direct_media","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoicGxheWltZGIiLCJ0bWRiUnVudGltZUtleVJlcXVpcmVkIjp0cnVlLCJ0bWRiVGltZW91dE1zIjoxMjAwfQ== */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:a8d6079f4fd2 */
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"playimdb","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
