...
/* FIXDATA:PROVIDER.WAVEANIME.CONFIG.V1:__ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌊 WaveAnime","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://waveanime.fr","modelSchemaVersion":4,"observedUrls":["https://waveanime.fr/","https://kitsu.io/api/edge/anime/${t}","https://kitsu.io/api/edge/anime?filter[text]=${encodeURIComponent(t","https://npms.io/search?q=ponyfill","https://lodash.com/","https://openjsf.org/","https://lodash.com/license","http://underscorejs.org/LICENSE","https://waveanime.fr"],"officialApi":null,"officialHub":null,"officialSite":"https://waveanime.fr","origins":["https://waveanime.fr","https://kitsu.io","https://npms.io","https://lodash.com","https://openjsf.org","http://underscorejs.org","https://underscorejs.org"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"waveanime","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api/edge/anime/${t}","/api/edge/anime?filter[text]=${encodeURIComponent(t","/search?q=ponyfill","/license","/LICENSE"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:ea4886f6f141 */
;(function(g,c){
  "use strict";
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10bWRiLWNhY2hlLWxhenktZXBpc29kZS12NyIsInByb3ZpZGVySWQiOiJ3YXZlYW5pbWUiLCJ0bWRiUnVudGltZUtleVJlcXVpcmVkIjp0cnVlLCJ0bWRiVGltZW91dE1zIjoxMjAwfQ== */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:21469d8416ec */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"waveanime","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-cache-lazy-episode-v7"});
/* CLOSEFIX:CORE.STREAM_IDENTITY.V1 */
/* STARTFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */
/* FIXDATA:CORE.MEDIA_TYPE_RESOLUTION.V1: */
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:ea30349f65e8 */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":30000,"tvProviderTimeoutMs":25000,"semanticTypes":["anime"],"requestTypeAliases":{},"revision":"tmdb-data-contract-launch-gate-v26-authoritative-context-reconcile","tmdbKeySalt":"26e924f27770847b22e162407e2c0292","tmdbKeyCipher":[14,208,241,103,174,223,126,201,204,235,5,19,107,95,169,8,81,49,64,111,119,96,235,169,188,253,89,154,66,154,215,254]});
/* CLOSEFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */
/* STARTFIX:CORE.STREAM_PRESENTATION.V1 */
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:ef56eb4bade9 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"waveanime","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY2IiwicHJvdmlkZXJFbW9qaSI6IvCfjIoiLCJwcm92aWRlcklkIjoid2F2ZWFuaW1lIiwicHJvdmlkZXJOYW1lIjoiV2F2ZUFuaW1lIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:2085cd27dd31 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"waveanime","providerName":"WaveAnime","providerEmoji":"🌊","implementationRevision":"post-presentation-name-title-quality-v6"});
