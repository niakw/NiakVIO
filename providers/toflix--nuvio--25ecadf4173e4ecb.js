...
/* FIXDATA:PROVIDER.TOFLIX.CONFIG.V1:eyJhcGlSZWNpcGUiOm51bGwsImF1dGhvcmluZyI6Im5pYWt2aW8tb3duZWQtdjMiLCJkaXNwbGF5TmFtZSI6IuKWtu-_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"▶️ ToFlix","domainSubstitutions":{"api.toflix.site":"api.tfx05.lol","toflix.site":"tfx05.lol"},"fixedApi":"https://api.tfx05.lol/toflix_api.php","identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://tfx05.lol","modelSchemaVersion":4,"observedUrls":["https://api.tfx05.lol/toflix_api.php","https://tfx05.lol/","https://api.tfx05.lol/","https://toflix.wiki/","https://apis.wavewatch.xyz/","https://tfx05.lol","https://api.tfx05.lol"],"officialApi":"https://api.tfx05.lol","officialHub":"https://toflix.wiki/","officialSite":"https://tfx05.lol","origins":["https://tfx05.lol","https://toflix.wiki","https://api.tfx05.lol","https://apis.wavewatch.xyz"],"outputLanguageRules":[{"hostPrefix":"french.","language":"fr"}],"outputUrlHostRewrites":[],"providerId":"toflix","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/player","/?tmdbId={tmdbId}&type=movie","/?tmdbId={tmdbId}&type=tv&season={season}&episode={episode}","//","/episode/"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"catalogue-html-embed","strategy":"direct_media","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoidG9mbGl4IiwidG1kYlJ1bnRpbWVLZXlSZXF1aXJlZCI6dHJ1ZSwidG1kYlRpbWVvdXRNcyI6MTIwMH0= */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:8eade6f65087 */
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"toflix","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IuKWtu-4jyIsInByb3ZpZGVySWQiOiJ0b2ZsaXgiLCJwcm92aWRlck5hbWUiOiJUb0ZsaXgifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:3b9f9e7fe7cf */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"toflix","providerName":"ToFlix","providerEmoji":"▶️","implementationRevision":"post-presentation-name-title-quality-v7"});
