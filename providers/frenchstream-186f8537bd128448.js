...
/* FIXDATA:PROVIDER.FRENCHSTREAM.CONFIG.V1:_ZG89c2VhcmNoJnN1YmFjdGlvbj1zZWFyY2gmc3Rvcnk9e3F1ZXJ5fSIsIi8_ZG89c2VhcmNoJnN1YmFjdGlvbj1zZWFyY2gmc3Rvcnk9e3F1ZXJ5fSIsIi8_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🇫🇷 Frenchstream","domainSubstitutions":{"french-stream.one":"fs16.lol","frenchstream.food":"fs16.lol","fs03.lol":"fs16.lol","fs09.lol":"fs16.lol"},"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://fs16.lol","modelSchemaVersion":4,"observedUrls":["https://fs16.lol"],"officialApi":null,"officialHub":"https://fstream.org/","officialSite":"https://fs16.lol","origins":["https://fs16.lol","https://fstream.org"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"frenchstream","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/index.php?do=search&subaction=search&story={query}","/?do=search&subaction=search&story={query}","/?s={query}"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"quarantined","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:2b37cb548db8 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"frenchstream","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-shared-tmdb-cache-native-zero-extra-fetch-v17-jvm-json-utf8"});
