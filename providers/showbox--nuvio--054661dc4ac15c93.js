...
/* FIXDATA:PROVIDER.SHOWBOX.CONFIG.V1:_c2hhcmVfa2V5PSIsImh0dHBzOi8vd3d3LmZlYmJveC5jb20vY29uc29sZS92aWRlb19xdWFsaXR5X2xpc3Q_ZmlkPSIsImh0dHBzOi8vd3d3LmZlYmJveC5jb20vIiwiaHR0cHM6Ly9pZC1tYXBwaW5nLWFwaS1zaG93Ym94LXByb3h5LmhmLnNwYWNlL2FwaS9tZWRpYSIsImh0dHBzOi8vd3d3LmZlYmJveC5jb20vbWJwL3RvX3NoYXJlX3BhZ2U__ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"📦 ShowBox","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://id-mapping-api-showbox-proxy.hf.space","modelSchemaVersion":4,"observedUrls":["https://www.febbox.com/file/file_share_list?share_key=","https://www.febbox.com/console/video_quality_list?fid=","https://www.febbox.com/","https://id-mapping-api-showbox-proxy.hf.space/api/media","https://www.febbox.com/mbp/to_share_page?box_type=","https://id-mapping-api-showbox-proxy.hf.space"],"officialApi":null,"officialHub":null,"officialSite":"https://id-mapping-api-showbox-proxy.hf.space","origins":["https://id-mapping-api-showbox-proxy.hf.space","https://www.febbox.com"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"showbox","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/?tmdbId={tmdbId}&type=movie","/?tmdbId={tmdbId}&type=tv&season={season}&episode={episode}","/file/file_share_list?share_key=","/api/media"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"catalogue-html","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoic2hvd2JveCIsInRtZGJSdW50aW1lS2V5UmVxdWlyZWQiOnRydWUsInRtZGJUaW1lb3V0TXMiOjEyMDB9 */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:1691cfb6d38f */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"showbox","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfk6YiLCJwcm92aWRlcklkIjoic2hvd2JveCIsInByb3ZpZGVyTmFtZSI6IlNob3dCb3gifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:b68546a86d1b */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"showbox","providerName":"ShowBox","providerEmoji":"📦","implementationRevision":"post-presentation-name-title-quality-v7"});
