...
/* FIXDATA:PROVIDER.YFLIX.CONFIG.V1:_dG1kYklkPTE1NzMzNiZ0eXBlPW1vdmllIiwiaHR0cHM6Ly8xbW92aWVzei50by8_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🇾 YFlix","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://1moviesz.to","modelSchemaVersion":4,"observedUrls":["https://enc-dec.app/api","https://enc-dec.app/db/flix","https://1moviesz.to/ajax","https://1moviesz.to/api","https://1moviesz.to/","https://1moviesz.to/?tmdbId=157336&type=movie","https://1moviesz.to/?tmdbId=1396&type=tv&season=1&episode=1","https://1moviesz.to"],"officialApi":null,"officialHub":null,"officialSite":"https://1moviesz.to","origins":["https://1moviesz.to","https://enc-dec.app"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"yflix","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"catalogue-html-embed","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoieWZsaXgiLCJ0bWRiUnVudGltZUtleVJlcXVpcmVkIjp0cnVlLCJ0bWRiVGltZW91dE1zIjoxMjAwfQ== */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:31222bdad46c */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"yflix","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfh74iLCJwcm92aWRlcklkIjoieWZsaXgiLCJwcm92aWRlck5hbWUiOiJZRmxpeCJ9 */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:73d0e3e4a0d2 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"yflix","providerName":"YFlix","providerEmoji":"🇾","implementationRevision":"post-presentation-name-title-quality-v7"});
