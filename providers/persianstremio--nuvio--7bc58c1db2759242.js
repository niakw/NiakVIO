...
/* FIXDATA:PROVIDER.PERSIANSTREMIO.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌸 PersianStremio","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://persianstremio.vercel.app","modelSchemaVersion":4,"observedUrls":["https://persianstremio.vercel.app/","https://persianstremio.vercel.app"],"officialApi":"https://persianstremio.vercel.app","officialHub":null,"officialSite":"https://persianstremio.vercel.app","origins":["https://persianstremio.vercel.app"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"persianstremio","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/stream/movie/{id}.json","/stream/series/{id}:{season}:{episode}.json","/stream/movie/","/stream/series/"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"stremio-json","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoicGVyc2lhbnN0cmVtaW8iLCJ0bWRiUnVudGltZUtleVJlcXVpcmVkIjp0cnVlLCJ0bWRiVGltZW91dE1zIjoxMjAwfQ== */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:a7204a306dc6 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"persianstremio","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfjLgiLCJwcm92aWRlcklkIjoicGVyc2lhbnN0cmVtaW8iLCJwcm92aWRlck5hbWUiOiJQZXJzaWFuU3RyZW1pbyJ9 */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:72440d2bb981 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"persianstremio","providerName":"PersianStremio","providerEmoji":"🌸","implementationRevision":"post-presentation-name-title-quality-v7"});
