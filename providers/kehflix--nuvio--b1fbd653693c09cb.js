...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🎬 Kehflix","fixedApi":null,"knownSite":"https://kehflix.com","modelSchemaVersion":3,"observedUrls":["https://kehflix.com/","https://www.youtube.com/embed/kTGDxqUowq4","https://www.youtube.com/iframe_api","https://kehflix.wiki/"],"officialApi":null,"officialHub":"https://kehflix.wiki/","officialSite":"https://kehflix.com","origins":["https://kehflix.com","https://kehflix.wiki","https://www.youtube.com"],"providerId":"kehflix","reconstructionState":"learning-clean-seed","routePlanVersion":2,"routes":["/embed/kTGDxqUowq4","/iframe_api","/api/report","/api/track-view","/player","/api/track","/api/fp","/api/ad-link","/api/streams/working","/api/streams/dead","/api/streams/warm","/api/stream-gw","/api/streams/{media}?id&k","/search?q={query}","/search/{query}","/search?query={query}","/season/","/episode/"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"html_scraper","supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:a24d99ae1336 */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":25000,"semanticTypes":["movie","tv","anime"],"revision":"tmdb-api-first-every-provider-v11-global-budget","tmdbKeySalt":"26e924f27770847b22e162407e2c0292","tmdbKeyCipher":[14,208,241,103,174,223,126,201,204,235,5,19,107,95,169,8,81,49,64,111,119,96,235,169,188,253,89,154,66,154,215,254]});
