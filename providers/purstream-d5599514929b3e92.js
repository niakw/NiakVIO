...
/* FIXDATA:PROVIDER.PURSTREAM.CONFIG.V1:eyJhcGlSZWNpcGUiOnsiYmFzZSI6Imh0dHBzOi8vYXBpLnB1cnN0cmVhbS5pZC9hcGkvdjEiLCJkaXJlY3RTb3VyY2VzT25seSI6dHJ1ZSwiZXBpc29kZVJvdXRlIjoiL3N0cmVhbS97aWR9L2VwaXNvZGU_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":{"base":"https://api.purstream.id/api/v1","directSourcesOnly":true,"episodeRoute":"/stream/{id}/episode?season={season}&episode={episode}","idFields":["id"],"movieRoute":"/stream/{id}","referer":"https://purstream.id/","requestHeaders":{"Accept":"application/json","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36"},"requestTimeoutMs":5000,"searchRoute":"/search-bar/search/{query}","skipStatusOnHttpStatuses":[401,403,429],"sourceFields":["url","stream_url"],"statusApiPrefix":"api.","statusApiSuffix":"/api/v1","statusDomainField":"domain","statusUrl":"https://purstream.wiki/api/status","strictIdentity":true,"titleFields":["title"],"yearFields":["release_date"]},"authoring":"niakvio-owned-v3","displayName":"💧 Purstream","domainSubstitutions":{"api.purstream.art":"api.purstream.id","api.purstream.club":"api.purstream.id","api.purstream.wiki":"api.purstream.id","purstream.art":"purstream.id","purstream.club":"purstream.id","purstream.wiki":"purstream.id"},"fixedApi":"https://api.purstream.id/api/v1","identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://purstream.id","modelSchemaVersion":4,"observedUrls":["https://purstream.id","https://api.purstream.id/api/v1"],"officialApi":"https://api.purstream.id/api/v1","officialHub":"https://purstream.wiki","officialSite":"https://purstream.id","origins":["https://purstream.id","https://purstream.wiki","https://api.purstream.id"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"purstream","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":[],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"official_domain_hub","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:dc227077efb7 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"purstream","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-shared-tmdb-cache-native-zero-extra-fetch-v17-jvm-json-utf8"});
