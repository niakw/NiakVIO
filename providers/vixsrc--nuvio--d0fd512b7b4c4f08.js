...
/* FIXDATA:PROVIDER.VIXSRC.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🔌 VixSrc","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://komiknostalgia.id","modelSchemaVersion":4,"observedUrls":["https://komiknostalgia.id/","https://komiknostalgia.id"],"officialApi":null,"officialHub":null,"officialSite":"https://komiknostalgia.id","origins":["https://komiknostalgia.id"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"vixsrc","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api/tv/","/episode/","/api/movie/","/proxy-agent.js","/api/readable.js","/api/api-request.js","/api/abort-signal.js","/api/api-stream.js","/api/api-pipeline.js","/api/api-upgrade.js","/api/api-connect.js","/api/index.js","/stream/websocketerror.js","/stream/websocketstream.js"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"tmdb-direct-api","strategy":"quarantined","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoidml4c3JjIiwidG1kYlJ1bnRpbWVLZXlSZXF1aXJlZCI6dHJ1ZSwidG1kYlRpbWVvdXRNcyI6MTIwMH0= */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:fbff08e3a860 */
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vixsrc","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCflIwiLCJwcm92aWRlcklkIjoidml4c3JjIiwicHJvdmlkZXJOYW1lIjoiVml4U3JjIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:828b621e951c */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vixsrc","providerName":"VixSrc","providerEmoji":"🔌","implementationRevision":"post-presentation-name-title-quality-v7"});
