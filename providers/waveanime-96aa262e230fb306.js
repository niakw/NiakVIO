...
/* FIXDATA:PROVIDER.WAVEANIME.CONFIG.V1:__ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌊 WaveAnime","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://waveanime.fr","modelSchemaVersion":4,"observedUrls":["https://waveanime.fr/","https://waveanime.fr"],"officialApi":"https://waveanime.fr","officialHub":null,"officialSite":"https://waveanime.fr","origins":["https://waveanime.fr"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"waveanime","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api/series?query={query}","/api/series/{id}","/playback/{episode}/manifest.mpd","/api/series?query=X","/api/series/:id","/playback/:epId/manifest.mpd","/Media3","/resolvers.js","/api/series?limit=100","/api/episodes/:id).","/playback/subtitles/{epId}-{lang}-{full|forced}.ass","/playback/subtitles/{id}--.ass","/playback/:ep/manifest.mpd).","/api/series?query={query","/api/series/{id","/api/episodes/{id","/playback/{id}/manifest.mpd"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"catalogue-html-embed","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
