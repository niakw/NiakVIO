...
/* FIXDATA:PROVIDER.MALLUMV.CONFIG.V1:_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌴 MalluMV","domainSubstitutions":{"mallumv.cyou":"mallumv.space","mallumv.gay":"mallumv.space"},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://mallumv.Space","modelSchemaVersion":4,"observedUrls":["https://mallumv.gay/","https://pixeldrain.net/api/file/","https://mallumv.Space"],"officialApi":null,"officialHub":null,"officialSite":"https://mallumv.Space","origins":["https://mallumv.space","https://pixeldrain.net","https://mallumv.gay"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"mallumv","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/?tmdbId={tmdbId}&type=movie","/api/file/"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"catalogue-html-embed","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoibWFsbHVtdiIsInRtZGJSdW50aW1lS2V5UmVxdWlyZWQiOnRydWUsInRtZGJUaW1lb3V0TXMiOjEyMDB9 */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:d1a6b45c9b9a */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"mallumv","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfjLQiLCJwcm92aWRlcklkIjoibWFsbHVtdiIsInByb3ZpZGVyTmFtZSI6Ik1hbGx1TVYifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:2a1b7b9144ed */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"mallumv","providerName":"MalluMV","providerEmoji":"🌴","implementationRevision":"post-presentation-name-title-quality-v7"});
