...
/* FIXDATA:PROVIDER.VOIRANIME.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"👁️ VoirAnime","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://voiranime.homes","modelSchemaVersion":4,"observedUrls":["https://voiranime.homes"],"officialApi":null,"officialHub":"https://voiranime.org.uk/","officialSite":"https://voiranime.homes","origins":["https://voiranime.homes","https://voiranime.org.uk"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"voiranime","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":[],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.VOIRANIME.CONFIG.V1 */
/* STARTFIX:CORE.CATALOGUE_ALIAS_RECOVERY.V2 */
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:9262da43b988 */
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:be16074805b2 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"voiranime","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-shared-tmdb-cache-native-zero-extra-fetch-v17-jvm-json-utf8"});
