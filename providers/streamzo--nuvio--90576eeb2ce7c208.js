...
/* FIXDATA:CORE.HLS_RUNTIME_INTEGRITY.V1: */
/* NUVIO_HLS_RUNTIME_INTEGRITY_V1:1659239ded97 */
;(function(g,config){
  "use strict";
  ...
  install();
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":9000,"maxChildren":3,"maxRecoveryPages":6,"maxRecoveryCandidates":18,"implementationRevision":"native-vod-duration-proof-v9","probeAllUrls":true,"failClosedUnknown":false,"probeFirstSegmentNative":true,"nativeProbeMaxRows":8,"nativeProbeTimeoutMs":2500,"minimumVodDurationSeconds":90});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:f6833a231602 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"streamzo","providerLanguageMode":"vf","languageFallback":"VF","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-strongest-evidence-v22"});
