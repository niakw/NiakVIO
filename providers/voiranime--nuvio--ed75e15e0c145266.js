...
/* FIXDATA:PROVIDER.VOIRANIME.CONFIG.V1:_cz17cXVlcnl9IiwiL2FuaW1lL3tzbHVnfS8iLCIvYW5pbWUve3NsdWd9L3tlcGlzb2RlfS8iLCIvYW5pbWUve3NsdWd9L3tlcGlzb2RlfS8_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"👁️ VoirAnime","domainSubstitutions":{"voiranime.com":"voir-anime.to","voiranime.diy":"voir-anime.to","voiranime.store":"voir-anime.to"},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://voir-anime.to","modelSchemaVersion":4,"observedUrls":["https://voir-anime.to/","https://voir-anime.to"],"officialApi":null,"officialHub":"https://voiranime.org.uk/","officialSite":"https://voir-anime.to","origins":["https://voir-anime.to","https://voiranime.homes","https://video.sibnet.ru","https://vidmoly.to","https://my.mail.ru","https://fsvid.lol","https://vidzy.live","https://streamtape.com","https://sendvid.com","https://www.myvi.ru","https://younetu.org","https://vidoza.net","https://lecteurvideo.com","https://wookafr.center","https://up4fun.top","https://kitsu.io"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":["https://voir-anime.to"],"providerId":"voiranime","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["https://voir-anime.to/anime/{slug}/","/?s={query}","/anime/{slug}/","/anime/{slug}/{episode}/","/anime/{slug}/{episode}/?host={reader}"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"wordpress-search-episode","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.VOIRANIME.CONFIG.V1 */
/* STARTFIX:PROVIDER.VOIRANIME.HOMES.RUNTIME.V1 */
/* FIXDATA:PROVIDER.VOIRANIME.HOMES.RUNTIME.V1: */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"movieSite":"https://voir-anime.to","userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145 Safari/537.36","maxStreams":4});
/* CLOSEFIX:PROVIDER.VOIRANIME.HOMES.RUNTIME.V1 */

/* STARTFIX:PROVIDER.VOIRANIME.ANIME.RUNTIME.V2 */
/* FIXDATA:PROVIDER.VOIRANIME.ANIME.RUNTIME.V2: */
/* NIAKVIO_VOIRANIME_ANIME_RUNTIME_V5_MULTI_SERIES_FALLBACK */
/* NIAKVIO_PROVIDER_RUNTIME_RESOLVER_V1 */
...
function canonicalAnime(v,base){var u=absolute(v,base);if(!u)return"";try{var p=new URL(u);if(p.pathname.indexOf("/anime/")!==0)return"";return c.base+p.pathname+(p.search||"")+(p.hash||"")}catch(_e){return""}}
...
async function seriesPages(q){var bases=[slug(q.title)],direct=[],out=[],seen={};if(q.season>1){direct.push(c.base+"/anime/"+bases[0]+"-"+q.season+"/");direct.push(c.base+"/anime/"+bases[0]+"-saison-"+q.season+"/")}direct.push(c.base+"/anime/"+bases[0]+"/");direct.push(c.base+"/anime/"+bases[0]+"-vf/");direct.push(c.base+"/anime/"+bases[0]+"-vostfr/");for(var i=0;i<direct.length&&out.length<8;i++){var p=await get(direct[i],c.base+"/");if(p&&titleMatch(p.text,q.title)){var key=p.url||direct[i];if(!seen[key]){seen[key]=1;out.push(p)}}}var search=await get(c.base+"/?s="+encodeURIComponent(q.title),c.base+"/");if(search){var rows=searchCandidates(search.text,search.url||c.base+"/",q);for(var j=0;j<rows.length&&out.length<8;j++){var p2=await get(rows[j].url,search.url);if(p2&&titleMatch(p2.text,q.title)){var key2=p2.url||rows[j].url;if(!seen[key2]){seen[key2]=1;out.push(p2)}}}}return out}
...
function episodeUrl(html,base,q){var rows=[],seen={},re=/<a\b[^>]*href=["']([^"']+)["'][^>]*>([\s\S]*?)<\/a>/gi,m;while((m=re.exec(html||""))!==null&&rows.length<500){var u=canonicalAnime(m[1],base);if(!u||seen[u])continue;var low=u.toLowerCase();if(/\/(?:special|oav|ova|film|movie)(?:[-\/]|$)/i.test(low))continue;var sm=low.match(/(?:saison|season|s)[-_\/]*0*(\d{1,2})(?:\D|$)/i);if(sm&&Number(sm[1])!==Number(q.season))continue;seen[u]=1;var label=stripTags(m[2]),score=episodeScore(u,label,q),tail=low.match(/[-_\/]0*(\d{1,4})(?:-v(?:ostfr|f))?\/?(?:[?#].*)?$/i);if(tail&&Number(tail[1])===Number(q.episode))score+=320;if(/wp-manga-chapter|listing-chapters|list-chapter|episode|chapitre|chapter/i.test(m[0]))score+=20;rows.push({url:u,score:score})}rows.sort(function(a,b){return b.score-a.score});if(rows.length&&rows[0].score>=200)return rows[0].url;var indexed=rows.filter(function(r){return r.score>=20});if(q.episode>0&&indexed.length>=q.episode)return indexed[q.episode-1].url;var first=rows.length?rows[0].url:"";if(first){var mm=first.match(/^(.*\/)([^\/]*?)(\d+)(-v(?:ostfr|f))?\/?$/i);if(mm)return mm[1]+mm[2]+q.episode+(mm[4]||"")+"/"}return""}
...
async function resolveAnime(q){q=await metadata(q);if(!q.title)return null;var seriesRows=await seriesPages(q);if(!Array.isArray(seriesRows)||!seriesRows.length)return null;for(var si=0;si<seriesRows.length;si++){var series=seriesRows[si],ep=episodeUrl(series.text,series.url,q);if(!ep)continue;var page=await get(ep,series.url);if(!page)continue;var players=iframeUrls(page.text,page.url),labels=hostLabels(page.text);for(var i=0;i<labels.length&&players.length<12;i++){var hp=await get(page.url+(page.url.indexOf("?")>=0?"&":"?")+"host="+encodeURIComponent(labels[i]),page.url);if(!hp)continue;var found=iframeUrls(hp.text,hp.url);for(var j=0;j<found.length;j++)if(players.indexOf(found[j])<0)players.push(found[j])}if(!players.length||typeof _crawlDirectMedia!=="function")continue;var rows=[];try{rows=await _crawlDirectMedia(players,page.url,2)}catch(_e){rows=[]}if(!Array.isArray(rows)||!rows.length)continue;var lang=/(?:^|[-_\/])vf(?:[-_\/]|$)/i.test(String(series.url||"")+" "+String(page.url||""))?"VF":"VOSTFR",out=[],seen={};for(var k=0;k<rows.length&&out.length<c.maxStreams;k++){var x=rows[k];if(!x||!x.url||seen[x.url])continue;seen[x.url]=1;x.name=x.name||"VoirAnime";x.title=(x.title||q.title)+" | "+lang;x.language=x.language||lang;x.provider="voiranime";out.push(x)}if(out.length)return out}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"base":"https://voir-anime.to","maxStreams":4,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145 Safari/537.36"});
/* CLOSEFIX:PROVIDER.VOIRANIME.ANIME.RUNTIME.V2 */
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:6267a1fe9295 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"voiranime","providerLanguageMode":"vf","languageFallback":"VF","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:7c14297c36e0 */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"voiranime","capabilityStrategy":"mixed_embed_resolver","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi8J-Rge-4jyIsInByb3ZpZGVySWQiOiJ2b2lyYW5pbWUiLCJwcm92aWRlck5hbWUiOiJWb2lyQW5pbWUifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:1aee1239e18d */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"voiranime","providerName":"VoirAnime","providerEmoji":"👁️","implementationRevision":"post-safety-uniform-final-label-v10"});
