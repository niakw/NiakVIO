...
/* FIXDATA:PROVIDER.HIANIME.CONFIG.V1:_dG1kYklkPXt0bWRiSWR9JnR5cGU9dHYmc2Vhc29uPXtzZWFzb259JmVwaXNvZGU9e2VwaXNvZGV9IiwiL2FwaS9yZXNvbHZlP2lkPXtpZH0iLCIvc3RyZWFtL2dldFNvdXJjZXM_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌸 HiAnime","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://id-mapping-api-malid.hf.space","modelSchemaVersion":4,"observedUrls":["https://megaplay.buzz/","https://megacloud.bloggy.click/","https://vidwish.live/","https://id-mapping-api-malid.hf.space/api/resolve?id=","https://id-mapping-api-malid.hf.space"],"officialApi":null,"officialHub":null,"officialSite":"https://id-mapping-api-malid.hf.space","origins":["https://id-mapping-api-malid.hf.space","https://megaplay.buzz","https://megacloud.bloggy.click","https://vidwish.live"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"hianime","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/?tmdbId={tmdbId}&type=tv&season={season}&episode={episode}","/api/resolve?id={id}","/stream/getSources?id={id}","/episode/","/stream/s-3/","/stream/mal/","/stream/s-2/"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"tmdb-direct-api","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10di15ZWFyLXNvZnQtdjgiLCJwcm92aWRlcklkIjoiaGlhbmltZSIsInRtZGJSdW50aW1lS2V5UmVxdWlyZWQiOnRydWUsInRtZGJUaW1lb3V0TXMiOjEyMDB9 */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:6efecc058433 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"hianime","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tv-year-soft-v8"});
/* CLOSEFIX:CORE.STREAM_IDENTITY.V1 */
/* STARTFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */
/* FIXDATA:CORE.MEDIA_TYPE_RESOLUTION.V1: */
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:12fc525a7496 */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":30000,"tvProviderTimeoutMs":25000,"supersedeSettleMs":1200,"semanticTypes":["anime"],"requestTypeAliases":{},"revision":"tmdb-data-contract-launch-gate-v29-native-abort-race"});
...
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY3IiwicHJvdmlkZXJFbW9qaSI6IvCfjLgiLCJwcm92aWRlcklkIjoiaGlhbmltZSIsInByb3ZpZGVyTmFtZSI6IkhpQW5pbWUifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:0789383f9b79 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"hianime","providerName":"HiAnime","providerEmoji":"🌸","implementationRevision":"post-presentation-name-title-quality-v7"});
