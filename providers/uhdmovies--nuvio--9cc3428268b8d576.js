...
/* FIXDATA:PROVIDER.UHDMOVIES.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"📺 UHDMovies","domainSubstitutions":{"uhdmovies.autos":"uhdmovies.my"},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://uhdmovies.my","modelSchemaVersion":4,"observedUrls":["https://uhdmovies.autos","https://uhdmovies.autos/","https://uhdmovies.pink/","https://uhdmovies.my"],"officialApi":null,"officialHub":"https://mmodlist.org/","officialSite":"https://uhdmovies.my","origins":["https://uhdmovies.my","https://uhdmovies.autos","https://uhdmovies.pink"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"uhdmovies","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/?s={query}"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-form-html","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.UHDMOVIES.CONFIG.V1 */
/* STARTFIX:PROVIDER.UHDMOVIES.RUNTIME.V1 */
/* FIXDATA:PROVIDER.UHDMOVIES.RUNTIME.V1: */
...
function header(r,k){try{return r&&r.headers&&typeof r.headers.get==="function"?s(r.headers.get(k)||""):""}catch(_e){return""}}
function terminalResponse(r){if(!r)return false;var ct=header(r,"content-type").toLowerCase(),cr=header(r,"content-range");return Number(r.status)===206||!!cr||/^(?:video|audio)\//.test(ct)||/application\/(?:octet-stream|x-matroska)/.test(ct)}
async function request(url,opt){try{var o=Object.assign({redirect:"follow"},opt||{});o.headers=Object.assign(headers(o.referer||""),o.headers||{});delete o.referer;var r=typeof _fetch==="function"?await _fetch(url,o):await g.fetch(url,o);if(!r||r.ok===false)return null;var media=terminalResponse(r),body="";if(!media)try{body=await r.text()}catch(_bodyError){}return{url:r.url||url,text:body,status:r.status,headers:r.headers,terminalMedia:media,contentType:header(r,"content-type"),contentRange:header(r,"content-range")}}catch(_e){return null}}
...
async function findPosts(m){var b=base();if(!b||!m.title)return[];var routes=[b+"/?s="+encodeURIComponent(m.title),b+"/search/"+encodeURIComponent(m.title).replace(/%20/g,"+")],all=[],seen={};for(var ri=0;ri<routes.length;ri++){var q=await request(routes[ri],{referer:b+"/"});if(!q)continue;var rows=articleRows(q.text).map(function(r){return{url:abs(r.url,b),label:r.label,score:score(r,m)}}).filter(function(r){return r.url&&r.score>=70});for(var i=0;i<rows.length;i++)if(!seen[rows[i].url]){seen[rows[i].url]=1;all.push(rows[i])}if(all.length)break}all.sort(function(a,b){return b.score-a.score});return all.slice(0,3)}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"base":"","maxReleases":4,"maxGatewayValues":8,"maxDownloadButtons":8,"maxTerminals":12,"ua":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/149 Safari/537.36"});
/* CLOSEFIX:PROVIDER.UHDMOVIES.RUNTIME.V1 */
...
/* FIXDATA:CORE.MEDIA_TYPE_RESOLUTION.V1: */
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:8d73ab0ce98e */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":25000,"tvProviderTimeoutMs":25000,"supersedeSettleMs":1200,"fetchSliceMs":12000,"maxHardFailures":3,"semanticTypes":["movie"],"requestTypeAliases":{},"revision":"tmdb-data-contract-launch-gate-v34-anime-pre-network-semantic-gate"});
/* CLOSEFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */

/* STARTFIX:CORE.STREAM_PRESENTATION.V1 */
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:0d4fa81f9471 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"uhdmovies","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:a1e28295f83a */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"uhdmovies","capabilityStrategy":"html_scraper","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi8J-TuiIsInByb3ZpZGVySWQiOiJ1aGRtb3ZpZXMiLCJwcm92aWRlck5hbWUiOiJVSERNb3ZpZXMifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:88476cb00427 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"uhdmovies","providerName":"UHDMovies","providerEmoji":"📺","implementationRevision":"post-safety-uniform-final-label-v10"});
