...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"DesiFlix","fixedApi":null,"knownSite":"https://manifest.desitvhub.eu.org","modelSchemaVersion":3,"observedUrls":["https://manifest.desitvhub.eu.org/"],"officialApi":null,"officialHub":null,"officialSite":null,"origins":["https://manifest.desitvhub.eu.org"],"providerId":"desiflix","reconstructionState":"learning-clean-seed","routePlanVersion":2,"routes":["/stream/series/","/stream/movie/"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"html_scraper","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:7d62af7b7010 */
;(function(g,c){
  "use strict";
...
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:69057521f724 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"desiflix","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-positive-mismatch-runtime-tmdb-fail-open-v6"});
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:6a6c52275e9f */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"desiflix","providerLanguageMode":"vo","languageFallback":"VO","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-title-quality-ordered-description-runtime-tmdb-fail-open-v16-jvm-json-utf8"});
...
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:294037303c0f */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":25000,"semanticTypes":["movie","tv"],"revision":"tmdb-api-first-every-provider-v11-global-budget","tmdbKeySalt":"26e924f27770847b22e162407e2c0292","tmdbKeyCipher":[14,208,241,103,174,223,126,201,204,235,5,19,107,95,169,8,81,49,64,111,119,96,235,169,188,253,89,154,66,154,215,254]});
