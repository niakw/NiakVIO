...
/* FIXDATA:PROVIDER.ALLANIME.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌐 AllAnime","domainSubstitutions":{"aniwatchtv.watch":"ww2.aniwatch.fit"},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://ww2.aniwatch.fit","modelSchemaVersion":4,"observedUrls":["https://allanime.day/","https://api.allanime.day/api","https://youtu-chan.com/","https://allmanga.to/","https://ww2.aniwatch.fit"],"officialApi":null,"officialHub":"https://allanime.sa.com/","officialSite":"https://ww2.aniwatch.fit","origins":["https://ww2.aniwatch.fit","https://aniwatchtv.watch","https://allanime.day","https://api.allanime.day","https://youtu-chan.com","https://allmanga.to"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"allanime","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/api","/apivtwo/clock.json"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"tmdb-direct-api","strategy":"direct_media","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.ALLANIME.CONFIG.V1 */
/* STARTFIX:PROVIDER.ALLANIME.SITE.RUNTIME.V1 */
/* FIXDATA:PROVIDER.ALLANIME.SITE.RUNTIME.V1: */
/* NIAKVIO_ALLANIME_GRAPHQL_RUNTIME_V3 */
...
function searchHeaders(origin){origin=s(origin||c.searchOrigin);return{"User-Agent":c.ua,"Accept":"application/json, text/plain, */*","Content-Type":"application/json","Referer":origin.replace(/\/$/,"")+"/","Origin":origin.replace(/\/$/,"")}}
function sourceHeaders(){return{"User-Agent":c.ua,"Accept":"*/*","Referer":c.sourceReferer,"Origin":c.base}}
async function jsonPostAt(api,origin,query,variables){try{var r=await g.fetch(api,{method:"POST",headers:searchHeaders(origin),body:JSON.stringify({query:query,variables:variables}),redirect:"follow"});if(!r||!r.ok)return null;var raw=await r.text();try{return JSON.parse(raw)}catch(_e){return null}}catch(_e){return null}}
...
var CURRENT_SOURCE_GQL='query ($showId: String!, $translationType: VaildTranslationTypeEnumType!, $episodeString: String!) { episode( showId: $showId translationType: $translationType episodeString: $episodeString ) { episodeString sourceUrls } }';
var CURRENT_SOURCE_HASH="f4662f4b7510b26795dd53ef824a0bf1740fbbc5d1273fab18222ac831bca8d0";
var LEGACY_SOURCE_HASH="d405d0edd690624b66baba3068e0edc3ac90f1597d898a1ec8db4e5c43c00fec";
async function searchOneAt(title,mode,q,api,origin,authority){var j=await jsonPostAt(api,origin,SEARCH_GQL,{search:{allowAdult:false,allowUnknown:false,query:title},limit:40,page:1,translationType:mode,countryOrigin:"ALL"}),rows=j&&j.data&&j.data.shows&&j.data.shows.edges||[],best=null,bestScore=0;
  ...
  if(best&&best._id&&bestScore>=48){best.__niakvioAuthority=authority;return best}return null
}
async function searchOne(title,mode,q){var cur=await searchOneAt(title,mode,q,c.currentApi,c.currentOrigin,"current");if(cur)return cur;return await searchOneAt(title,mode,q,c.api,c.searchOrigin,"legacy")}
...
function subtle(){try{if(g&&g.crypto&&g.crypto.subtle)return g.crypto.subtle;if(typeof crypto!=="undefined"&&crypto.subtle)return crypto.subtle}catch(_e){}return null}
function b64Bytes(v){try{var x=s(v).replace(/-/g,"+").replace(/_/g,"/");while(x.length%4)x+="=";var raw=typeof atob==="function"?atob(x):(typeof Buffer!=="undefined"?Buffer.from(x,"base64").toString("binary"):""),a=new Uint8Array(raw.length);for(var i=0;i<raw.length;i++)a[i]=raw.charCodeAt(i)&255;return a}catch(_e){return null}}
function bytesB64(a){try{if(typeof Buffer!=="undefined")return Buffer.from(a).toString("base64");var raw="";for(var i=0;i<a.length;i++)raw+=String.fromCharCode(a[i]);return btoa(raw)}catch(_e){return""}}
function hexBytes(v){var x=s(v),out=new Uint8Array(Math.floor(x.length/2));for(var i=0;i<out.length;i++)out[i]=parseInt(x.slice(i*2,i*2+2),16)||0;return out}
async function shaBytes(v){var sub=subtle();if(!sub)return null;return new Uint8Array(await sub.digest("SHA-256",new TextEncoder().encode(String(v))))}
async function fetchDoc(url,headers){try{var r=await g.fetch(url,{headers:headers||{},redirect:"follow"});if(!r||!r.ok)return null;return{url:r.url||url,text:await r.text()}}catch(_e){return null}}
var aaCfgCache=null;
async function currentConfig(){if(aaCfgCache&&Date.now()-aaCfgCache.at<3600000)return aaCfgCache;var sub=subtle();if(!sub)return null;var page=await fetchDoc(c.currentOrigin,{"User-Agent":c.ua,"Accept":"text/html,*/*"});if(!page)return null;var epoch=(page.text.match(/"epoch"\s*:\s*(\d+)/)||[])[1]||"",partB=(page.text.match(/"partB"\s*:\s*"([^"]+)"/)||[])[1]||"",app=(page.text.match(/https:\/\/cdn\.mkissa\.net\/all\/mk\/_app\/immutable\/entry\/app\.[A-Za-z0-9_.-]+\.js/)||[])[0]||"";if(!epoch||!partB||!app)return null;var appDoc=await fetchDoc(app,{"User-Agent":c.ua,"Referer":c.currentOrigin+"/"});if(!appDoc)return null;var chunks=[],re=/"\.\.\/chunks\/([A-Za-z0-9_.-]+\.js)"/g,m;while((m=re.exec(appDoc.text))!==null&&chunks.length<6)if(chunks.indexOf(m[1])<0)chunks.push(m[1]);var maskHex="";for(var ci=0;ci<chunks.length&&!maskHex;ci++){var ch=await fetchDoc(c.currentCdn+"/chunks/"+chunks[ci],{"User-Agent":c.ua,"Referer":c.currentOrigin+"/"});if(ch){var hm=ch.text.match(/\b[0-9a-f]{64}\b/i);if(hm)maskHex=hm[0]}}var part=b64Bytes(partB),mask=hexBytes(maskHex);if(!part||part.length<32||mask.length<32)return null;var raw=new Uint8Array(32);for(var i=0;i<32;i++)raw[i]=part[i]^mask[i];var key=await sub.importKey("raw",raw,{name:"AES-GCM"},false,["encrypt","decrypt"]);aaCfgCache={epoch:Number(epoch),key:key,at:Date.now()};return aaCfgCache}
async function buildAaReq(cfg){var sub=subtle();if(!sub||!cfg)return"";var ts=Math.floor(Date.now()/300000)*300000,hash=await shaBytes(String(cfg.epoch)+":"+CURRENT_SOURCE_HASH+":"+String(ts));if(!hash)return"";var iv=hash.slice(0,12),payload=new TextEncoder().encode(JSON.stringify({v:1,ts:ts,epoch:cfg.epoch,qh:CURRENT_SOURCE_HASH})),sealed=new Uint8Array(await sub.encrypt({name:"AES-GCM",iv:iv,tagLength:128},cfg.key,payload)),blob=new Uint8Array(1+12+sealed.length);blob[0]=1;blob.set(iv,1);blob.set(sealed,13);return bytesB64(blob)}
async function decryptParsedCurrent(v,cfg){try{var sub=subtle(),bytes=b64Bytes(v);if(!sub||!cfg||!bytes||bytes.length<30)return null;var iv=bytes.slice(1,13),sealed=bytes.slice(13),plain=await sub.decrypt({name:"AES-GCM",iv:iv,tagLength:128},cfg.key,sealed),raw=new TextDecoder().decode(plain),j=JSON.parse(raw);return j&&j.episode&&j.episode.sourceUrls||j&&j.sourceUrls||null}catch(_e){return null}}
async function decryptParsedLegacy(v){try{var sub=subtle();if(!sub)return null;var bytes=b64Bytes(v);if(!bytes||bytes.length<30)return null;var seed=new TextEncoder().encode("Xot36i3lK3:v1"),keyBytes=await sub.digest("SHA-256",seed),key=await sub.importKey("raw",keyBytes,{name:"AES-CTR"},false,["decrypt"]),counter=new Uint8Array(16);counter.set(bytes.slice(1,13),0);counter[15]=2;var ct=bytes.slice(13,bytes.length-16),plain=await sub.decrypt({name:"AES-CTR",counter:counter,length:32},key,ct),raw=new TextDecoder().decode(plain),j=JSON.parse(raw);return j&&j.episode&&j.episode.sourceUrls||j&&j.sourceUrls||null}catch(_e){return null}}
async function sourceRowsCurrent(showId,mode,ep){var cfg=await currentConfig();if(!cfg)return[];var variables={showId:showId,translationType:mode,episodeString:String(ep)},token=await buildAaReq(cfg);if(!token)return[];var extensions={persistedQuery:{version:1,sha256Hash:CURRENT_SOURCE_HASH},aaReq:token},url=c.currentApi+"?variables="+encodeURIComponent(JSON.stringify(variables))+"&extensions="+encodeURIComponent(JSON.stringify(extensions)),headers=searchHeaders(c.currentOrigin);try{var r=await g.fetch(url,{headers:headers,redirect:"follow"});if(!r||!r.ok)return[];var j=await r.json(),err=s(j&&j.errors&&j.errors[0]&&j.errors[0].message);if(err.indexOf("PersistedQueryNotFound")===0){r=await g.fetch(url,{method:"POST",headers:headers,body:JSON.stringify({query:CURRENT_SOURCE_GQL,variables:variables,extensions:extensions}),redirect:"follow"});if(!r||!r.ok)return[];j=await r.json()}var data=j&&j.data;if(data&&data.episode&&Array.isArray(data.episode.sourceUrls))return data.episode.sourceUrls;if(data&&data.tobeparsed)return await decryptParsedCurrent(data.tobeparsed,cfg)||[];return[]}catch(_e){return[]}}
async function sourceRowsLegacy(showId,mode,ep){var variables={showId:showId,translationType:mode,episodeString:String(ep)},url=c.api+"?variables="+encodeURIComponent(JSON.stringify(variables))+"&extensions="+encodeURIComponent(JSON.stringify({persistedQuery:{version:1,sha256Hash:LEGACY_SOURCE_HASH}}));try{var r=await g.fetch(url,{headers:sourceHeaders(),redirect:"follow"});if(!r||!r.ok)return[];var j=await r.json(),data=j&&j.data;if(data&&data.episode&&Array.isArray(data.episode.sourceUrls))return data.episode.sourceUrls;if(data&&data.tobeparsed)return await decryptParsedLegacy(data.tobeparsed)||[];return[]}catch(_e){return[]}}
async function sourceRows(showId,mode,ep,authority){var a=authority==="legacy"?await sourceRowsLegacy(showId,mode,ep):await sourceRowsCurrent(showId,mode,ep);if(a&&a.length)return a;return authority==="legacy"?await sourceRowsCurrent(showId,mode,ep):await sourceRowsLegacy(showId,mode,ep)}
...
function siteCandidates(html,page){var out=[],seen={};function add(v){var u=s(v).replace(/&amp;/gi,"&").replace(/\\\//g,"/");try{u=new URL(u,page).toString()}catch(_e){return}if(!/^https?:\/\//i.test(u)||seen[u])return;seen[u]=1;out.push(u)}var re=/(?:src|href|data-src)\s*=\s*["']([^"']+)["']/gi,m;while((m=re.exec(html||""))!==null&&out.length<60)add(m[1]);var raw=/https?:\\?\/\\?\/[^"'\\s<>]+/gi,x;while((x=raw.exec(html||""))!==null&&out.length<80)add(x[0]);try{if(typeof _extractUrls==="function"){var ext=_extractUrls(html||"",page)||[];for(var i=0;i<ext.length&&out.length<120;i++)add(ext[i])}}catch(_e){}try{if(typeof _spv241ExplicitPlayerPayloadUrls==="function"){var enc=_spv241ExplicitPlayerPayloadUrls(html||"",page)||[];for(var j=0;j<enc.length&&out.length<140;j++)add(enc[j])}}catch(_e){}return out}
async function fetchSitePage(page){try{var r=await g.fetch(page,{headers:{"User-Agent":c.ua,"Accept":"text/html,application/xhtml+xml,*/*","Referer":c.siteBase.replace(/\/$/,"")+"/"},redirect:"follow"});if(!r||!r.ok)return null;return{url:r.url||page,text:await r.text()}}catch(_e){return null}}
async function siteFallback(meta,q){if(!c.siteBase)return[];var names=meta.aliases||[meta.title],abs=absoluteEpisode(q,meta),episodes=uniq([abs,q.episode]),modes=[{suffix:"english-subbed",lang:"VOSTA"},{suffix:"english-dubbed",lang:"English Dub"}],out=[],seen={};for(var ni=0;ni<names.length&&ni<4&&out.length<c.maxStreams;ni++){var slug=siteSlug(names[ni]);if(!slug)continue;for(var ei=0;ei<episodes.length&&out.length<c.maxStreams;ei++){for(var mi=0;mi<modes.length&&out.length<c.maxStreams;mi++){var page=c.siteBase.replace(/\/$/,"")+"/"+slug+"-episode-"+episodes[ei]+"-"+modes[mi].suffix,doc=await fetchSitePage(page);if(!doc)continue;var candidates=siteCandidates(doc.text,doc.url),rows=[];try{if(typeof _crawlDirectMedia==="function"){if(candidates.length)rows=await _crawlDirectMedia(candidates,doc.url,3);if((!Array.isArray(rows)||!rows.length))rows=await _crawlDirectMedia([doc.url],doc.url,3)}}catch(_e){rows=[]}if(!Array.isArray(rows)||!rows.length)continue;for(var ri=0;ri<rows.length&&out.length<c.maxStreams;ri++){var row=rows[ri]||{},u=s(row.url);if(!/^https?:\/\//i.test(u)||seen[u])continue;seen[u]=1;var x=Object.assign({},row);x.provider="allanime";x.name="AllAnime | "+modes[mi].lang;x.title=meta.title+" | S"+q.season+"E"+q.episode+" | "+modes[mi].lang;x.language=modes[mi].lang;if(!x.headers)x.headers={"Referer":doc.url,"User-Agent":c.ua};out.push(x)}if(out.length)return out}}}return out}
async function resolve(a){var q=req(a);if(q===null)return null;if(!q||!q.tmdbId)return[];var meta=await metadata(q);if(!meta||!meta.title)return[];var modes=["sub","dub"],episodes=[q.episode],abs=absoluteEpisode(q,meta),out=[];if(abs!==q.episode)episodes.push(abs);
  for(var mi=0;mi<modes.length&&out.length<c.maxStreams;mi++){var mode=modes[mi],show=await findShow(meta,q,mode);if(!show)continue;for(var ei=0;ei<episodes.length&&out.length<c.maxStreams;ei++){var rows=await sourceRows(show._id,mode,episodes[ei],show.__niakvioAuthority||"");if(!rows.length)continue;var got=await resolveRows(rows,mode,meta,q);for(var gi=0;gi<got.length&&out.length<c.maxStreams;gi++)out.push(got[gi]);if(got.length)break}}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"api":"https://api.allanime.day/api","currentApi":"https://api.mkissa.net/api","currentOrigin":"https://mkissa.to","currentCdn":"https://cdn.mkissa.net/all/mk/_app/immutable","base":"https://allanime.day","clockBase":"https://allanime.day","searchOrigin":"https://allmanga.to","sourceReferer":"https://youtu-chan.com","referer":"https://allanime.day/","siteBase":"https://ww2.aniwatch.fit","maxStreams":6,"ua":"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:150.0) Gecko/20100101 Firefox/150.0"});
/* CLOSEFIX:PROVIDER.ALLANIME.SITE.RUNTIME.V1 */
/* NUVIO_GLOBAL_CORE_START_BOUNDARY_V1 */
/* STARTFIX:CORE.HLS_RUNTIME_INTEGRITY.V1 */
/* FIXDATA:CORE.HLS_RUNTIME_INTEGRITY.V1: */
/* NUVIO_HLS_RUNTIME_INTEGRITY_V1:5add1bf02cc9 */
;(function(g,config){
  "use strict";
  ...
  install();
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":6500,"maxChildren":2,"maxRecoveryPages":4,"maxRecoveryCandidates":12,"implementationRevision":"native-master-facts-v12","probeFirstSegmentNative":true,"nativeProbeMaxRows":8,"nativeProbeTimeoutMs":2500,"minimumVodDurationSeconds":90,"dropUnprobedHlsAfterBudget":true,"shortStaticMediaSeconds":30,"inspectMasterFacts":true});
...
/* STARTFIX:CORE.PROVIDER_RUNTIME_DISPATCH.V1 */
/* FIXDATA:CORE.PROVIDER_RUNTIME_DISPATCH.V1: */
...
/* CLOSEFIX:CORE.PROVIDER_RUNTIME_DISPATCH.V1 */
...
/* FIXDATA:CORE.MEDIA_TYPE_RESOLUTION.V1: */
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:4d1308f15c97 */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":25000,"tvProviderTimeoutMs":25000,"supersedeSettleMs":1200,"fetchSliceMs":12000,"maxHardFailures":3,"semanticTypes":["anime"],"requestTypeAliases":{},"revision":"tmdb-data-contract-launch-gate-v34-anime-pre-network-semantic-gate"});
/* CLOSEFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */

/* STARTFIX:CORE.STREAM_PRESENTATION.V1 */
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:0139c7afb547 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
function blob(r){return [r&&r.name,r&&r.title,r&&r.size,r&&r.description,r&&r.quality,r&&r.resolution,r&&r.height,r&&r.width,r&&r.label,r&&r.language,r&&r.codec,r&&r.videoCodec,r&&r.audio,r&&r.audioCodec,r&&r.audioChannels,r&&r.channels,r&&r.audioSampleRate,r&&r.sampleRate,r&&r.frameRate,r&&r.fps,r&&r.sourceType,r&&r.releaseType,r&&r.format,r&&r.type,r&&r.mimeType,r&&r.hdr,r&&r.videoTech,r&&r.bitDepth,r&&r.subtitles,r&&r.sourceLabel,r&&r.filename,r&&r.edition,r&&r.releaseGroup,r&&r.release_group,r&&r.videoBitrate,r&&r.bitrate,r&&r.container,r&&r.encode,r&&r.indexer,r&&r.network,urlFacts(r)].map(s).join(" ")}
function quality(r){
  var u=blob(r).toUpperCase(),best=0,m,re=/\b(4320|2160|1440|1080|720|576|480|360|240)P?\b/g;
  if(/\b1080I\b/.test(u))return"1080i";
  if(/(?:\b8K\b|\b4320P?\b)/.test(u))best=4320;else if(/(?:\b4K\b|\b2160P?\b|\bUHD\b)/.test(u))best=2160;
  while((m=re.exec(u))!==null)best=Math.max(best,Number(m[1]||0)); if(/\b(?:FULL[ ._-]?HD|FHD)\b/.test(u))best=Math.max(best,1080); if(/\bHD\b/.test(u))best=Math.max(best,720); if(/\bSD\b/.test(u))best=Math.max(best,480);
  var h=Number(r&&r.height||0);if(h>=4000)best=Math.max(best,4320);else if(h>=2000)best=Math.max(best,2160);else if(h>=1350)best=Math.max(best,1440);else if(h>=900)best=Math.max(best,1080);else if(h>=650)best=Math.max(best,720);else if(h>=540)best=Math.max(best,576);else if(h>=450)best=Math.max(best,480);else if(h>=330)best=Math.max(best,360);else if(h>=220)best=Math.max(best,240);
...
function detailedLanguage(r,fallback){
  var raw=s(r&&r.language),all=[raw,r&&r.languages,r&&r.languageTracks,r&&r.audioLanguage,r&&r.audioLanguages,r&&r.audioTracks,r&&r.sourceLanguage,r&&r.sourceLanguages,r&&r.sourceName,r&&r.sourceTitle,r&&r.sourceLabel].map(s).join(" ").toLowerCase().replace(/[_-]+/g," ").replace(/\s+/g," ").trim();
...
function languageCode(v){var raw=s(v);if(/\bVFQ\b/i.test(raw)||/\bFR[-_ ]?CA\b/i.test(raw))return"fr-ca";var embedded=raw.match(/(?:^|[^a-z0-9])(fr[-_ ]?ch|pt[-_ ]?br|pt[-_ ]?pt|es[-_ ]?419|es[-_ ]?mx|zh[-_ ]?hk|zh[-_ ]?tw)(?:[^a-z0-9]|$)/i);if(embedded)return embedded[1].toLowerCase().replace(/[_ ]/g,"-");var k=raw.toLowerCase().replace(/_/g,"-").replace(/\s+/g," ").trim(),loc={"fr-ca":"fr-ca",vfq:"fr-ca","canadian french":"fr-ca","french canada":"fr-ca","fr-ch":"fr-ch","swiss french":"fr-ch","pt-br":"pt-br","brazilian portuguese":"pt-br","pt-pt":"pt-pt","european portuguese":"pt-pt","es-419":"es-419","latam spanish":"es-419","es-mx":"es-mx","mexican spanish":"es-mx","zh-hk":"zh-hk","hong kong chinese":"zh-hk","zh-tw":"zh-tw","traditional chinese":"zh-tw"},x=raw.toLowerCase().replace(/[_-]+/g," ").replace(/\([^)]*\)/g," ").replace(/\s+/g," ").trim(),a={en:"en",eng:"en",english:"en",fr:"fr",fra:"fr",fre:"fr",french:"fr",francais:"fr",français:"fr",vf:"fr",vff:"fr",de:"de",deu:"de",ger:"de",german:"de",es:"es",spa:"es",spanish:"es",bn:"bn",ben:"bn",bengali:"bn",pt:"pt",por:"pt",portuguese:"pt",bg:"bg",bul:"bg",bulgarian:"bg",zh:"zh",zho:"zh",chi:"zh",chinese:"zh",mandarin:"zh",ko:"ko",kor:"ko",korean:"ko",ar:"ar",ara:"ar",arabic:"ar",fi:"fi",fin:"fi",finnish:"fi",el:"el",ell:"el",gre:"el",greek:"el",hu:"hu",hun:"hu",hungarian:"hu",hi:"hi",hin:"hi",hindi:"hi",id:"id",ind:"id",indonesian:"id",fa:"fa",fas:"fa",per:"fa",persian:"fa",farsi:"fa",he:"he",heb:"he",hebrew:"he",it:"it",ita:"it",italian:"it",ja:"ja",jpn:"ja",japanese:"ja",ku:"ku",kur:"ku",kurdish:"ku",uz:"uz",uzb:"uz",uzbek:"uz",fil:"fil",filipino:"fil",tagalog:"fil",tgl:"fil",pl:"pl",pol:"pl",polish:"pl",ro:"ro",ron:"ro",rum:"ro",romanian:"ro",ru:"ru",rus:"ru",russian:"ru",sk:"sk",slk:"sk",slo:"sk",slovak:"sk",sv:"sv",swe:"sv",swedish:"sv",cs:"cs",ces:"cs",cze:"cs",czech:"cs",vi:"vi",vie:"vi",vietnamese:"vi",tr:"tr",tur:"tr",turkish:"tr",ta:"ta",tam:"ta",tamil:"ta",te:"te",tel:"te",telugu:"te",ml:"ml",mal:"ml",malayalam:"ml",kn:"kn",kan:"kn",kannada:"kn",pa:"pa",pan:"pa",punjabi:"pa",gu:"gu",guj:"gu",gujarati:"gu",mr:"mr",mar:"mr",marathi:"mr",ur:"ur",urd:"ur",urdu:"ur",yue:"yue",cantonese:"yue"};if(loc[k])return loc[k];if(a[x])return a[x];var first=x.split(" ")[0];return a[first]||""}
function languageName(code){return({en:"English",fr:"French",de:"German",es:"Spanish",bn:"Bengali",pt:"Portuguese",bg:"Bulgarian",zh:"Chinese",ko:"Korean",ar:"Arabic",fi:"Finnish",el:"Greek",hu:"Hungarian",hi:"Hindi",id:"Indonesian",fa:"Persian",he:"Hebrew",it:"Italian",ja:"Japanese",ku:"Kurdish",uz:"Uzbek",fil:"Filipino",pl:"Polish",ro:"Romanian",ru:"Russian",sk:"Slovak",sv:"Swedish",cs:"Czech",vi:"Vietnamese",tr:"Turkish",ta:"Tamil",te:"Telugu",ml:"Malayalam",kn:"Kannada",pa:"Punjabi",gu:"Gujarati",mr:"Marathi",ur:"Urdu",yue:"Cantonese","fr-ca":"French (Canada)","fr-ch":"French (Switzerland)","pt-br":"Portuguese (Brazil)","pt-pt":"Portuguese (Portugal)","es-419":"Spanish (Latin America)","es-mx":"Spanish (Mexico)","zh-hk":"Chinese (Hong Kong)","zh-tw":"Chinese (Taiwan)"})[code]||String(code||"").toUpperCase()}
...
function languageTracks(r,meta){var original=languageCode(meta&&meta.originalLanguage),out=[];function add(code,role){if(!code)return;var row={code:code,tag:code.toUpperCase(),label:languageName(code),role:role||null};for(var z=0;z<out.length;z++)if(out[z].code===row.code&&out[z].role===row.role)return;out.push(row)}var candidates=[r&&r.audioTracks,r&&r.audio_tracks,r&&r.audioLanguages,r&&r.audio_languages,r&&r.availableAudioTracks,r&&r.available_audio_tracks,r&&r.languages],rows=[];for(var ci=0;ci<candidates.length;ci++)if(Array.isArray(candidates[ci])&&candidates[ci].length){rows=candidates[ci];break}for(var i=0;i<rows.length;i++){var row=rows[i],value=typeof row==="string"?row:(row&&(row.language||row.lang||row.code||row.name||row.label||row.title)),code=languageCode(value),role=languageRole(typeof row==="string"?row:(row&&(row.role||row.kind||row.type||row.name||row.label)));if(code)add(code,role||(original?(code===original?"Original":"Dub"):""))}var explicit=meaningful(r&&r.language)?s(r.language):"",u=explicit.toUpperCase();if(!rows.length&&explicit){if(/\bVOSTFR\b/.test(u)){if(original)add(original,"Original");add("fr","Sub")}else if(/^(?:VO|ORIGINAL(?:[ ._-]?(?:AUDIO|LANG(?:UAGE)?))?)$/i.test(explicit)){if(original)add(original,"Original")}else if(/^(?:VFQ|FR[ ._-]?CA)$/i.test(explicit)){add("fr-ca",original==="fr-ca"?"Original":"Dub")}else if(/^(?:VF|VFF|FR|FRA|FRE|FRENCH|FRANCAIS|FRANÇAIS)$/i.test(explicit)){add("fr",original==="fr"?"Original":"Dub")}else if(/\bMULTI\b|\bDUAL(?:[- ]?AUDIO)?\b/i.test(explicit)){if(original)add(original,"Original");if(s(c.providerLanguageMode).toLowerCase()==="vf"&&original!=="fr")add("fr","Dub")}else{explicit.split(/\s*(?:\/|,|\+|\||;)\s*/).forEach(function(part){var code=languageCode(part);if(code)add(code,languageRole(part)||(original?(code===original?"Original":"Dub"):""))})}}var subs=[];[r&&r.subtitles,r&&r.extCaptions,r&&r.captions,r&&r.hlsMasterSubtitleTracks,r&&r.subtitleTracks].forEach(function(rows){if(Array.isArray(rows))rows.forEach(function(row){subs.push(row)})});for(var j=0;j<subs.length;j++){var sr=subs[j],sv=typeof sr==="string"?sr:(sr&&(sr.language||sr.lanName||sr.langName||sr.lan||sr.lang||sr.code||sr.name||sr.label)),sc=languageCode(sv);if(sc)add(sc,"Sub")}if(/\bVOSTFR\b/i.test([r&&r.language,r&&r.description,r&&r.title].map(s).join(" ")))add("fr","Sub");return out}
function compactTrack(t){return t&&t.tag?t.tag+(t.role?" "+t.role:""):""}
function fullTrack(t){return t&&t.label?t.label+(t.role?" · "+t.role:""):""}
function codec(r){var v=meaningful(r&&(r.codec||r.videoCodec))?s(r.codec||r.videoCodec):blob(r),u=v.toUpperCase();if(/\b(?:HEVC|H[ ._-]?265|X265|HVC1|HEV1)\b/.test(u))return"HEVC";if(/\b(?:AV1|AV01)\b/.test(u))return"AV1";if(/\b(?:VP9|VP09)\b/.test(u))return"VP9";if(/\b(?:AVC|H[ ._-]?264|X264|AVC1)\b/.test(u))return"AVC";if(/\b(?:MPEG[ ._-]?2|MPEG2)\b/.test(u))return"MPEG-2";if(/\b(?:VC[ ._-]?1|WVC1)\b/.test(u))return"VC-1";if(/\b(?:MPEG[ ._-]?4[ ._-]?(?:PART[ ._-]?2|ASP)|XVID|DIVX)\b/.test(u))return"MPEG-4 Part 2";return meaningful(r&&(r.codec||r.videoCodec))?s(r.codec||r.videoCodec):""}
function audioFacts(r){var u=(s(r&&r.audio)+" "+blob(r)).toUpperCase(),tech=[],codec="",ch="",sr="",cm=u.match(/\b(7\.1|5\.1|2\.1|2\.0|1\.0)\b/);if(cm)ch=cm[1];else if(/\b(?:STEREO|2[ ._-]?CH)\b/.test(u))ch="2.0";else if(/\b(?:MONO|1[ ._-]?CH)\b/.test(u))ch="1.0";if(/\b(?:ATMOS|DOLBY ATMOS|E-?AC-?3[ ._-]?JOC)\b/.test(u))tech.push("Dolby Atmos");if(/\bDTS[: ._-]?X\b/.test(u))tech.push("DTS:X");if(/\bTRUE[ ._-]?HD\b/.test(u))codec="TrueHD";else if(/\b(?:E-?AC-?3|DDP|DD\+)\b/.test(u))codec="E-AC3";else if(/\bAC-?3\b/.test(u))codec="AC3";else if(/\bDTS[- ._]?HD[ ._-]?(?:MA|MASTER)\b/.test(u))codec="DTS-HD MA";else if(/\bDTS[- ._]?HD[ ._-]?(?:HRA|HIGH[ ._-]?RES)\b/.test(u))codec="DTS-HD HRA";else if(/\bDTS[- ]?HD\b/.test(u))codec="DTS-HD";else if(/\bDTS\b/.test(u))codec="DTS";else if(/\bAAC\b/.test(u))codec="AAC";else if(/\bFLAC\b/.test(u))codec="FLAC";else if(/\bLPCM\b/.test(u))codec="LPCM";else if(/\bPCM\b/.test(u))codec="PCM";else if(/\bOPUS\b/.test(u))codec="Opus";else if(/\bMP3\b/.test(u))codec="MP3";else if(/\bALAC\b/.test(u))codec="ALAC";var sm=u.match(/\b(44\.1|48|88\.2|96|192)\s*K?HZ\b/);if(sm)sr=sm[1]+" kHz";else{var hz=u.match(/\b(44100|48000|88200|96000|192000)\s*HZ\b/);if(hz)sr=(Number(hz[1])/1000)+" kHz"}return{tech:uniq(tech),codec:codec,channels:ch,sampleRate:sr}}
...
function source(r){var raw=(s(r&&r.sourceType)+" "+s(r&&r.releaseType)+" "+blob(r)),u=raw.toUpperCase(),sourceType="",releaseType="";if(/\b(?:ULTRA[ ._-]?HD[ ._-]?BLU[ ._-]?RAY|UHD[ ._-]?BLU[ ._-]?RAY|UHD[ ._-]?BD)\b/.test(u))sourceType="ULTRA HD BLU-RAY";else if(/\bBDMV\b/.test(u))sourceType="BDMV";else if(/\b(?:BLU[- ]?RAY|BDRIP|BRRIP|BDREMUX)\b/.test(u))sourceType="BLU-RAY";else if(/\bWEB[- .]?DL\b/.test(u))sourceType="WEB-DL";else if(/\bWEB[- .]?RIP\b/.test(u))sourceType="WEBRIP";else if(/\bHDTV\b/.test(u))sourceType="HDTV";else if(/\bDVD[- .]?RIP\b/.test(u))sourceType="DVD RIP";else if(/\bDVD\b/.test(u))sourceType="DVD";else if(/\b(?:HD[ ._-]?CAM|CAMRIP|CAM)\b/.test(u))sourceType="CAM";else if(/\b(?:TELE[ ._-]?SYNC|TSRIP)\b/.test(u))sourceType="TELESYNC";else if(/\b(?:TELECINE|TCRIP)\b/.test(u))sourceType="TELECINE";if(/\bREMUX\b/.test(u))releaseType="REMUX";return{sourceType:sourceType||(meaningful(r&&r.sourceType)?s(r.sourceType):""),releaseType:releaseType||(meaningful(r&&r.releaseType)?s(r.releaseType):"")}}
function formatType(r){var v=meaningful(r&&(r.format||r.container||r.type||r.mimeType||r.contentType))?s(r.format||r.container||r.type||r.mimeType||r.contentType):"",u=v.toUpperCase();if(/(?:M3U8|HLS|MPEGURL)/.test(u))return"HLS";if(/(?:MPD|DASH)/.test(u))return"DASH";if(/\b(?:MATROSKA|MKV)\b/.test(u))return"MKV";if(/\b(?:MP4|M4V)\b/.test(u))return"MP4";if(/\bWEBM\b/.test(u))return"WEBM";if(/\bM2TS\b/.test(u))return"M2TS";if(/(?:MPEG[ ._-]?TS|MPEGTS|MP2T)/.test(u))return"MPEG-TS";var url=s(r&&r.url).split(/[?#]/)[0].toLowerCase();if(/\.m3u8$/.test(url))return"HLS";if(/\.mpd$/.test(url))return"DASH";if(/\.mp4$|\.m4v$/.test(url))return"MP4";if(/\.mkv$/.test(url))return"MKV";if(/\.webm$/.test(url))return"WEBM";if(/\.m2ts$/.test(url))return"M2TS";if(/\.ts$/.test(url))return"MPEG-TS";return v}
function videoFacts(r){var u=blob(r).toUpperCase(),tech=[],bit="";if(/\b(?:DOLBY VISION|DOVI)\b/.test(u))tech.push("Dolby Vision");if(/\bHDR10\+\b|\bHDR10 PLUS\b/.test(u))tech.push("HDR10+");else if(/\bHDR10\b/.test(u))tech.push("HDR10");else if(/\bHDR\b/.test(u))tech.push("HDR");if(/\bHLG\b/.test(u))tech.push("HLG");if(/\bSDR\b/.test(u))tech.push("SDR");if(/\bIMAX[ ._-]?ENHANCED\b/.test(u))tech.push("IMAX Enhanced");else if(/\bIMAX\b/.test(u))tech.push("IMAX");if(/\b3D\b|SBS|TAB/.test(u))tech.push("3D");if(/\b12[ ._-]?BIT\b/.test(u))bit="12bit";else if(/\b10[ ._-]?BIT\b|\bHI10P\b/.test(u))bit="10bit";else if(/\b8[ ._-]?BIT\b/.test(u))bit="8bit";return{tech:uniq(tech),bitDepth:bit}}
function frameRate(r){var u=blob(r).replace(/,/g,"."),m=u.match(/\b(23\.976|24(?:\.0+)?|25(?:\.0+)?|29\.97|30(?:\.0+)?|50(?:\.0+)?|59\.94|60(?:\.0+)?)\s*(?:FPS|HZ)?\b/i);if(!m)return"";var n=Number(m[1]);if(Math.abs(n-23.976)<.01)return"23.976 fps";if(Math.abs(n-29.97)<.01)return"29.97 fps";if(Math.abs(n-59.94)<.01)return"59.94 fps";return[24,25,30,50,60].indexOf(Math.round(n))>=0?Math.round(n)+" fps":""}
function bitrateValue(r){return meaningful(r&&(r.videoBitrate||r.video_bitrate||r.bitrate||r.bitRate||r.bit_rate))?s(r.videoBitrate||r.video_bitrate||r.bitrate||r.bitRate||r.bit_rate):""}
function subtitleFacts(r){var u=blob(r),out=[];function add(x){var c=languageCode(x);if(c)out.push("SUB "+c.toUpperCase())}if(/\bVOSTFR\b/i.test(u))out.push("SUB FR");var re=/\bSUB(?:TITLE)?S?[ ._-]?([A-Z]{2,3}(?:-[A-Z0-9]{2,3})?)\b/gi,m;while((m=re.exec(u))!==null)add(m[1]);[r&&r.subtitles,r&&r.extCaptions,r&&r.captions,r&&r.hlsMasterSubtitleTracks,r&&r.subtitleTracks].forEach(function(rows){if(!Array.isArray(rows))return;rows.forEach(function(row){add(typeof row==="string"?row:(row&&(row.language||row.lanName||row.langName||row.lan||row.lang||row.code||row.name||row.label)))})});if(/\bFORCED\b/i.test(u))out.push("FORCED");if(/\bSDH\b|\bCLOSED[ ]?CAPTION\b|\bCC\b/i.test(u))out.push("SDH");return uniq(out)}
function normalizeAgeValue(v){var u=s(v).toUpperCase().replace(/\s+/g," ").trim(),m=u.match(/^(?:AGE[ ._-]*)?(0|6|7|10|12|13|14|15|16|17|18|19|21)\+?$/);if(!u)return"";var fr=u.match(/^(?:-|INTERDIT\s+(?:AUX\s+)?MOINS\s+DE\s+)(10|12|16|18)\b/);if(fr)return fr[1]+"+";if(m)return m[1]+"+";return s(v)}
function age(r){var v=r&&(r.ageRating||r.certification||r.contentRating);return meaningful(v)?normalizeAgeValue(v):""}
...
function languageLine(f){var rawTracks=f.languageTracks||[],tracks=rawTracks.map(fullTrack).filter(Boolean),subCodes={};for(var i=0;i<rawTracks.length;i++)if(String(rawTracks[i]&&rawTracks[i].role||"").toLowerCase()==="sub"&&rawTracks[i].code)subCodes[String(rawTracks[i].code).toLowerCase()]=1;var subs=(f.subtitles||[]).filter(function(v){var m=s(v).match(/^SUB\s+([A-Z]{2,3}(?:-[A-Z0-9]{2,3})?)$/i),c=m?languageCode(m[1]):"";return !c||!subCodes[c]});if(tracks.length)return"🌐 "+tracks.join(" • ")+(subs.length?" • 💬 "+subs.join(" • "):"");var code=languageCode(f.language),lang=code?languageName(code):"";if(!lang&&!subs.length)return"";return"🌐 "+[lang,subs.length?"💬 "+subs.join(" • "):""].filter(Boolean).join(" • ")}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allanime","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
;(function(g,config){
  ...
  async function probeResolved(stream,url,depth,referer){
    ...
    try{
      ...
      var bytes=await prefixBytes(response,controller),text=ascii(bytes);try{if(stream&&typeof stream==="object")stream.__nuvioProbeBytesV1=Number(bytes&&bytes.length||0)||0}catch(_e){}
  ...
  function install(container,key){
    ...
    var wrapped=async function(){
      ...
      async function checkItem(item){
        ...
        var probeStarted=(typeof Date!=="undefined"&&Date.now)?Date.now():0;
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:ef245a3e6f59 */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
  ...
  function durationSeconds(text){var body=s(text);if(!/#EXT-X-ENDLIST(?:\s|$)/i.test(body)&&!/#EXT-X-PLAYLIST-TYPE\s*:\s*VOD\b/i.test(body))return null;var total=0,count=0,re=/#EXTINF\s*:\s*([0-9]+(?:\.[0-9]+)?)/gi,m;while((m=re.exec(body))!==null){var n=Number(m[1]);if(Number.isFinite(n)&&n>0){total+=n;count++}}return count?total:null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allanime","capabilityStrategy":"direct_media","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi8J-MkCIsInByb3ZpZGVySWQiOiJhbGxhbmltZSIsInByb3ZpZGVyTmFtZSI6IkFsbEFuaW1lIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:f588b049fade */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allanime","providerName":"AllAnime","providerEmoji":"🌐","implementationRevision":"post-safety-uniform-final-label-v10"});
/* CLOSEFIX:CORE.PROVIDER_BRANDING.V1 */

/* STARTFIX:CORE.STREAM_SCORE.V1 */
/* FIXDATA:CORE.STREAM_SCORE.V1: */
/* NUVIO_GLOBAL_STREAM_SCORE_V1:00d1a54bac4d */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
...
function network(r,mediaBr){var e=r&&r.__nuvioStreamNetworkEvidenceV1;if(!e||e.success!==true)return null;var parts=[],detail={source:s(e.source||"terminal-media-probe")},through=n(e.sampleMbps),sampleConf=n(e.sampleConfidence);if(through!=null&&mediaBr){var hr=through/Math.max(.1,mediaBr);detail.sampleMbps=Math.round(through*100)/100;detail.headroomRatio=Math.round(hr*1000)/1000;parts.push([.55,curve(hr,[[.5,5],[.8,20],[1,40],[1.25,60],[1.5,75],[2.5,90],[4,98],[6,100]]),sampleConf==null?.55:Math.min(1,sampleConf)])}var latency=n(e.latencyMs);if(latency!=null){detail.latencyMs=Math.round(latency);parts.push([.30,curve(latency,[[0,100],[100,100],[250,95],[500,88],[1000,75],[2000,55],[4000,30],[8000,10],[12000,0]]),1])}parts.push([.15,100,1]);var w=0,t=0,conf=0;for(var i=0;i<parts.length;i++){w+=parts[i][0];t+=parts[i][0]*parts[i][1];conf+=parts[i][0]*parts[i][2]}return{score:t/w,confidence:Math.min(1,conf),detail:detail}}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"schemaVersion":1,"implementationRevision":"evidence-gated-global-score-v1","minimumConfidence":0.6,"weights":{"videoQuality":45,"sourceProvenance":10,"audioQuality":10,"playbackNetwork":30,"providerReliability":5}});
/* CLOSEFIX:CORE.STREAM_SCORE.V1 */
