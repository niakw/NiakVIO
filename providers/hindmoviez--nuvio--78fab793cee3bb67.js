...
/* FIXDATA:PROVIDER.HINDMOVIEZ.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🇮🇳 HindMoviez","domainSubstitutions":{"hindmovie.fit":"hindmovie.icu"},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://hindmovie.icu","modelSchemaVersion":4,"observedUrls":["https://mvlink.blog/wp-admin/admin-ajax.php","https://hindmovie.icu/","https://hindmovie.icu"],"officialApi":null,"officialHub":"https://t.me/s/hindmoviez/1975","officialSite":"https://hindmovie.icu","origins":["https://hindmovie.icu","https://hindmovie.fit","https://mvlink.blog"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"hindmoviez","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/{slug}"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-form-html","strategy":"direct_media","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.HINDMOVIEZ.CONFIG.V1 */
/* STARTFIX:PROVIDER.HINDMOVIEZ.RUNTIME.V1 */
/* FIXDATA:PROVIDER.HINDMOVIEZ.RUNTIME.V1: */
/* NIAKVIO_HINDMOVIEZ_RUNTIME_V1 */
/* NIAKVIO_PROVIDER_RUNTIME_RESOLVER_V1 */
;(function(g,c){"use strict";
function S(v){return String(v==null?"":v).trim()}
function A(a){var f=a[0],o=f&&typeof f==="object"&&!Array.isArray(f)?f:null,x={};try{x=g.__nuvioMediaContext||{}}catch(_e){}var t=S((o&&(o.canonicalMediaType||o.semanticType||o.mediaType||o.type))||a[1]||x.canonicalMediaType||x.mediaType||"").toLowerCase();if(t==="series")t="tv";if(t!=="movie"&&t!=="tv")return null;var explicit=S((o&&(o.imdbId||o.imdb_id||o.imdb))||x.imdbId||x.imdb_id||x.imdb||""),raw=S((o&&(o.tmdbId||o.tmdb_id||o.id))||(typeof f==="string"?f:"")||x.tmdbId||"").replace(/^tmdb:/i,"").split(":")[0];return{type:t,imdbId:/^tt\d+$/i.test(explicit)?explicit:"",tmdbId:/^\d+$/.test(raw)?raw:"",season:Number((o&&o.season)!=null?o.season:(a[2]!=null?a[2]:x.season))||1,episode:Number((o&&o.episode)!=null?o.episode:(a[3]!=null?a[3]:x.episode))||1}}
...
function SIG(){try{return typeof AbortSignal!=="undefined"&&AbortSignal.timeout?AbortSignal.timeout(c.requestTimeoutMs):undefined}catch(_e){return undefined}}
...
async function G(url,ref,accept){if(expired())return null;try{var o={method:"GET",redirect:"follow",headers:H(ref,accept)},sg=SIG();if(sg)o.signal=sg;var r=await g.fetch(url,o);if(!r||!r.ok)return null;return{text:await r.text(),url:r.url||url,status:r.status,headers:r.headers}}catch(_e){return null}}
async function POST(url,body,ref){if(expired())return null;try{var h=H(ref,"application/json,text/plain,*/*");h["Content-Type"]="application/x-www-form-urlencoded; charset=UTF-8";h["X-Requested-With"]="XMLHttpRequest";var o={method:"POST",redirect:"follow",headers:h,body:body},sg=SIG();if(sg)o.signal=sg;var r=await g.fetch(url,o);if(!r||!r.ok)return null;return{text:await r.text(),url:r.url||url,status:r.status}}catch(_e){return null}}
function coreImdb(d){if(!d)return"";if(d.state==="ok"&&d.metadata)d=d.metadata;var e=d.external_ids||d.externalIds||{},v=S(d.imdb_id||d.imdbId||d.imdb||e.imdb_id||e.imdbId||e.imdb);return /^tt\d+$/i.test(v)?v:""}
async function fromCore(q){try{var fn=g&&g.__nuvioCoreGetTmdbDataV1;if(typeof fn==="function"&&q.tmdbId){var z=await fn({tmdbId:q.tmdbId,mediaType:q.type,tmdbNamespace:q.type}),v=coreImdb(z&&z.metadata||z);if(v)return v}}catch(_e){}try{var x=g&&g.__nuvioMediaContext||{},v2=coreImdb(x.tmdbMetadata||x.metadata||x);if(v2)return v2}catch(_e){}return""}
async function fromWikidata(q){if(!q.tmdbId)return"";var prop=q.type==="movie"?"P4947":"P4983",query='SELECT ?imdb WHERE { ?item wdt:'+prop+' "'+q.tmdbId+'"; wdt:P345 ?imdb. } LIMIT 3',url=c.wikidata+"?format=json&query="+encodeURIComponent(query),r=await G(url,"","application/sparql-results+json");if(!r)return"";try{var j=JSON.parse(r.text),a=j&&j.results&&j.results.bindings||[];for(var i=0;i<a.length;i++){var v=S(a[i]&&a[i].imdb&&a[i].imdb.value);if(/^tt\d+$/i.test(v))return v}}catch(_e){}return""}
async function imdb(q){if(q.imdbId)return q.imdbId;var v=await fromCore(q);return v||await fromWikidata(q)}
...
function hshareUrl(src){try{var d=JSON.parse(src),u=S(d&&d.data&&d.data.url);if(/^https?:\/\/hshare\.(?:lol|ink)\//i.test(u))return u}catch(_e){}var xs=URLs(src,/https?:\/\/hshare\.(?:lol|ink)\/[^\s"'<>\\]+/gi);return xs[0]||""}
...
async function chain(mv,type,season,episode){var page=await G(mv,c.siteRef);if(!page)return[];var names=files(page.text,type,season,episode),out=[];for(var i=0;i<names.length&&!expired();i++){var f=names[i],body="action=hindshare_sign&d="+encodeURIComponent(B64(f)),sig=await POST(c.mvAjax,body,page.url);if(!sig)continue;var hs=hshareUrl(sig.text);if(!hs)continue;var hp=await G(hs,page.url);if(!hp)continue;var hc=hcloudUrl(hp.text);if(!hc)continue;var cp=await G(hc,hp.url);if(!cp)continue;var us=finals(cp.text);for(var j=0;j<us.length;j++)out.push({name:"HindMoviez | "+quality(f),title:f,filename:f,sourceName:f,url:us[j],quality:quality(f),language:"Hindi/English",headers:H(cp.url,"*/*"),provider:"hindmoviez",isDirect:true});if(out.length>=4)break}return out}
async function resolve(a){var q=A(a);if(q===null)return null;if(!q||(!q.imdbId&&!q.tmdbId))return[];var iid=await imdb(q);if(!iid||expired())return[];var api=c.api+"?search="+encodeURIComponent(iid)+"&per_page=100",r=await G(api,c.siteRef,"application/json,*/*");if(!r)return[];var rows=[];try{rows=JSON.parse(r.text)}catch(_e){}if(!Array.isArray(rows))return[];var links=[],seen={};for(var i=0;i<rows.length;i++){var m=mvlinks(rows[i],q.type);for(var j=0;j<m.length;j++)if(!seen[m[j]]){seen[m[j]]=1;links.push(m[j])}}var out=[],urlSeen={};for(var k=0;k<links.length&&k<8&&!expired();k++){var z=await chain(links[k],q.type,q.season,q.episode);for(var n=0;n<z.length;n++)if(!urlSeen[z[n].url]){urlSeen[z[n].url]=1;out.push(z[n])}if(out.length>=4)break}try{if(g)g.__niakvioHindMoviezLastProof={tmdbId:q.tmdbId,imdbId:iid,type:q.type,count:out.length}}catch(_e){}return out}
try{if(g)g.__niakvioProviderRuntimeResolverV1={provider:"hindmoviez",resolve:resolve}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"api":"https://hindmovie.icu/wp-json/wp/v2/posts","siteRef":"https://hindmovie.fit/","mvAjax":"https://mvlink.blog/wp-admin/admin-ajax.php","wikidata":"https://query.wikidata.org/sparql","requestTimeoutMs":7000,"ua":"Mozilla/5.0 (Linux; Android 14; Pixel 8 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36"});
/* CLOSEFIX:PROVIDER.HINDMOVIEZ.RUNTIME.V1 */
...
/* FIXDATA:CORE.MEDIA_TYPE_RESOLUTION.V1: */
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:19bf50cdc6f5 */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":25000,"tvProviderTimeoutMs":25000,"supersedeSettleMs":1200,"fetchSliceMs":12000,"maxHardFailures":3,"semanticTypes":["movie","tv"],"requestTypeAliases":{},"revision":"tmdb-data-contract-launch-gate-v34-anime-pre-network-semantic-gate"});
/* CLOSEFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */

/* STARTFIX:CORE.STREAM_PRESENTATION.V1 */
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:83cda502012a */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"hindmoviez","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:f09093efc52c */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"hindmoviez","capabilityStrategy":"direct_media","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi8J-HrvCfh7MiLCJwcm92aWRlcklkIjoiaGluZG1vdmlleiIsInByb3ZpZGVyTmFtZSI6IkhpbmRNb3ZpZXoifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:03d361562e14 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"hindmoviez","providerName":"HindMoviez","providerEmoji":"🇮🇳","implementationRevision":"post-safety-uniform-final-label-v10"});
