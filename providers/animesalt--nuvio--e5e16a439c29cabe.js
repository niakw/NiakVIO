...
/* FIXDATA:PROVIDER.ANIMESALT.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🧂 AnimeSalt","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://animesalt.cx","modelSchemaVersion":4,"observedUrls":["https://animesalt.link/","https://animesalt\\x5c.link/episode/[^\\x22]*","https://as-cdn21.top/","https://animesalt.cx"],"officialApi":null,"officialHub":"https://animesalt.ac/","officialSite":"https://animesalt.cx","origins":["https://animesalt.cx","https://as-cdn21.top","https://animesalt.link","https://animesalt\\x5c.link"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"animesalt","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/?tmdbId={tmdbId}&type=tv&season={season}&episode={episode}","/?tmdbId={tmdbId}&type=movie"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-html-embed","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.ANIMESALT.CONFIG.V1 */
/* STARTFIX:PROVIDER.ANIMESALT.RUNTIME.V1 */
/* FIXDATA:PROVIDER.ANIMESALT.RUNTIME.V1: */
...
function req(a){var f=a[0],o=f&&typeof f==="object"&&!Array.isArray(f)?f:null,x={};try{x=g&&g.__nuvioMediaContext||{}}catch(_e){}
  ...
  if(!/^\d+$/.test(id))return[];
  return{tmdbId:id,season:Number((o&&o.season)!=null?o.season:(a[2]!=null?a[2]:x.season))||1,episode:Number((o&&o.episode)!=null?o.episode:(a[3]!=null?a[3]:x.episode))||1,metadata:(o&&(o.tmdbMetadata||o.tmdb_metadata||o.metadata))||null}
}
...
function projectedMeta(value){var m=value;if(m&&m.state==="ok"&&m.metadata)m=m.metadata;if(!m||typeof m!=="object")return null;var title=s(m.name||m.title||m.original_name||m.original_title),year=Number(s(m.first_air_date||m.release_date||m.year).slice(0,4))||0;return title?{title:title,year:year}:null}
async function meta(q){var direct=projectedMeta(q&&q.metadata);if(direct)return direct;try{var fn=g&&g.__nuvioCoreGetTmdbDataV1;if(typeof fn==="function"){var z=await fn({tmdbId:q.tmdbId,mediaType:"tv",tmdbNamespace:"tv"}),m=projectedMeta(z&&z.metadata||z);if(m)return m}}catch(_e){}
  try{var x=g&&g.__nuvioMediaContext||{},m2=projectedMeta(x.tmdbMetadata||x.fixtureMetadata);if(m2)return m2;var t=s(x.title);if(t)return{title:t,year:Number(s(x.year).slice(0,4))||0}}catch(_e2){}return null}
...
async function directSeries(m){var slug=norm(m&&m.title).replace(/\s+/g,"-");if(!slug)return null;var u=runtimeBase()+"/series/"+slug+"/",p=await getText(u,runtimeBase()+"/");if(!p)return null;var body=norm(text(p.text||"")),wanted=norm(m.title);if(body.indexOf(wanted)<0&&!/\/episode\//i.test(p.text||""))return null;return{url:p.url||u,type:"series",score:400,label:m.title,page:p}}
async function findSeries(m){var direct=await directSeries(m);if(direct)return direct;var ajax=await ajaxSeries(m);if(ajax)return ajax;var p=await getText(runtimeBase()+"/?s="+encodeURIComponent(m.title),runtimeBase()+"/");if(!p)return null;var rows=searchRows(p.text,p.url,m.title,m.year);for(var i=0;i<rows.length;i++)if(rows[i].type==="series")return rows[i];return null}
...
async function episodePage(series,q){var root=series&&series.page||await getText(series.url,runtimeBase()+"/");if(!root)return null;var direct=episodeHref(root.text,q.season,q.episode,root.url);if(direct)return await getText(direct,series.url);
...
})(typeof globalThis!=="undefined"?globalThis:this,{"base":"https://animesalt.cx","maxStreams":2,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/120.0.0.0 Safari/537.36"});
/* CLOSEFIX:PROVIDER.ANIMESALT.RUNTIME.V1 */
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:80a859df1d1d */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"animesalt","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:05fd179affd6 */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"animesalt","capabilityStrategy":"html_scraper","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi8J-ngiIsInByb3ZpZGVySWQiOiJhbmltZXNhbHQiLCJwcm92aWRlck5hbWUiOiJBbmltZVNhbHQifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:8c04c089c0ee */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"animesalt","providerName":"AnimeSalt","providerEmoji":"🧂","implementationRevision":"post-safety-uniform-final-label-v10"});
