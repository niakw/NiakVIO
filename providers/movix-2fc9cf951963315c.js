...
/* FIXDATA:PROVIDER.MOVIX.CONFIG.V1:_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🎥 Movix","domainSubstitutions":{"api.movix.cash":"api.movix.fun","api.movix.cloud":"api.movix.fun","movix.cash":"movix.fun"},"fixedApi":"https://api.movix.fun","identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://movix.fun","modelSchemaVersion":4,"observedUrls":["https://movix.fun","https://api.movix.fun"],"officialApi":"https://api.movix.fun","officialHub":"https://movix.online/","officialSite":"https://movix.fun","origins":["https://movix.fun","https://movix.online","https://api.movix.fun"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"movix","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api/swiftflow/movie/{id}","/api/swiftflow/tv/{id}/season/{season}?episode={episode}","/api/wiflix/movie/{id}","/api/wiflix/tv/{id}/{season}"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:4fc1656530c9 */
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:13a0740fb4dc */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"movix","providerLanguageMode":"vf","languageFallback":"VF","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-shared-tmdb-cache-native-zero-extra-fetch-v17-jvm-json-utf8"});
