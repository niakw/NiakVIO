...
/* FIXDATA:PROVIDER.DVDPLAY.CONFIG.V1:_dG1kYklkPXt0bWRiSWR9JnR5cGU9bW92aWUiLCIvYXBpL2ZpbGUvIiwiL3NlYXJjaC5waHA_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"💿 DVDPlay","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://dvdplay.cv","modelSchemaVersion":4,"observedUrls":["https://dvdplay.cv/","https://pixeldrain.net/api/file/","https://dvdplay.cv"],"officialApi":null,"officialHub":null,"officialSite":"https://dvdplay.cv","origins":["https://dvdplay.cv","https://pixeldrain.net"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"dvdplay","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/?tmdbId={tmdbId}&type=tv&season={season}&episode={episode}","/?tmdbId={tmdbId}&type=movie","/api/file/","/search.php?q={query}","/video/natzr1pnbteetra","/video/{id}","/video/kszspgzgzb4p4ws","/video/ovauavh1c_c35z3","/video/awhpozpzcw7chnp","/video/vyepzher7fiqvce","/video/k1pkgddldmdgddd","/video/b1jvsyz1ye31vhs","/video/putqr78fuircgvu"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-html-embed","strategy":"quarantined","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.DVDPLAY.CONFIG.V1 */
/* NUVIO_GLOBAL_CORE_START_BOUNDARY_V1 */
/* STARTFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:870d935db7a2 */
;(function(g,c){
  "use strict";
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:0cab334d363d */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"dvdplay","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-language-detail-v21"});
