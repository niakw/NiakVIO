...
/* FIXDATA:PROVIDER.ANIKOTOTV.CONFIG.V1:_ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"📺 AnikotoTV","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://anikototv.to/home","modelSchemaVersion":4,"observedUrls":["https://api4.thetvdb.com/v4/search?query=","https://api4.thetvdb.com/v4/series/","https://api4.thetvdb.com/v4/login","https://aiometadata.elfhosted.com/stremio/80d082c4-6e99-4c97-a67d-3d9e242685ce/meta/series/","https://anikototv.to/home"],"officialApi":null,"officialHub":"https://streamingsiteshub.com/","officialSite":"https://anikototv.to/home","origins":["https://anikototv.to","https://api4.thetvdb.com","https://aiometadata.elfhosted.com"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"anikototv","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/api/v2/tmdb?id={tmdbId}&s={season}&e={episode}","/stream/{identityKind}/{identityId}/{episode}/{mode}","/stream/getSources?id={id}"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"tmdb-direct-api","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.ANIKOTOTV.CONFIG.V1 */
/* STARTFIX:PROVIDER.ANIKOTOTV.RUNTIME.V2 */
/* FIXDATA:PROVIDER.ANIKOTOTV.RUNTIME.V2: */
...
async function sourceFile(j){var src=j&&j.sources,file="";if(src&&typeof src==="object"&&!Array.isArray(src))file=s(src.file||src.url||src.src);if(!file&&Array.isArray(src)){for(var i=0;i<src.length;i++){var r=src[i],u=s(r&&typeof r==="object"?(r.file||r.url||r.src):r);if(/^https?:\/\//i.test(u)){file=u;break}}}if(!file&&j&&j.enc)file=await decryptMega(j.enc);file=normalizeMegaMedia(file,j&&j.tracks);return /^https?:\/\//i.test(file)?file:""}
...
async function getSources(page,domain){var id=(String(page.text||"").match(/data-id=["'](\d+)["']/i)||[])[1]||"";if(!id){var im=(String(page.text||"").match(/<iframe[^>]+src=["']([^"']+)/i)||[])[1]||"";if(im){try{var iu=new URL(im,page.url).toString(),p2=await textGet(iu,page.url);if(p2){id=(String(p2.text||"").match(/data-id=["'](\d+)["']/i)||[])[1]||"";if(id)page=p2}}catch(_e){}}}if(!id)return null;try{var endpoint="https://"+domain+"/stream/getSources?id="+encodeURIComponent(id),r=await g.fetch(endpoint,{headers:hdr(page.url,{"X-Requested-With":"XMLHttpRequest"}),redirect:"follow"});if(!r||!r.ok)return null;var j=await r.json(),u=await sourceFile(j);if(!u)return null;return{url:u,subtitles:tracks(j)}}catch(_e){return null}}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"mapping":"https://arm.haglund.dev/api/v2/tmdb","domain":"megaplay.buzz","modes":["sub","dub"],"ua":"Mozilla/5.0 (Linux; Android 14; Pixel 8 Pro) AppleWebKit/537.36 Chrome/124.0.0.0 Mobile Safari/537.36"});
/* CLOSEFIX:PROVIDER.ANIKOTOTV.RUNTIME.V2 */
...
function ua(){return"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/120.0.0.0 Safari/537.36"}
function h(ref,xhr,cookie,origin){var out={"User-Agent":ua(),"Accept":"text/html,application/json,text/plain,*/*"};if(ref)out.Referer=ref;if(xhr)out["X-Requested-With"]="XMLHttpRequest";if(cookie)out.Cookie=cookie;if(origin)out.Origin=origin;return out}
...
function megaLike(url){try{var host=new URL(url).hostname.toLowerCase();return host==="megaplay.buzz"||host.endsWith(".megaplay.buzz")||host==="rapid-cloud.co"||host.endsWith(".rapid-cloud.co")}catch(_e){return false}}
function mediaHeaders(){return{Referer:"https://megaplay.buzz/",Origin:"https://megaplay.buzz","User-Agent":ua()}}
function mediaValue(v){var u=s(v);return /^https?:\/\//i.test(u)&&(/\.(?:m3u8|mpd|mp4|mkv|webm)(?:[?#]|$)/i.test(u)||/\/hls(?:\/|[?#])/i.test(u))?u:""}
function nestedMedia(v,depth){if(depth>5||v==null)return"";if(typeof v==="string")return mediaValue(v);if(Array.isArray(v)){for(var i=0;i<v.length&&i<24;i++){var a=nestedMedia(v[i],depth+1);if(a)return a}return""}if(typeof v!=="object")return"";var keys=["file","url","src","sources","source","links","data","result","stream","streams"];for(var k=0;k<keys.length;k++){if(Object.prototype.hasOwnProperty.call(v,keys[k])){var hit=nestedMedia(v[keys[k]],depth+1);if(hit)return hit}}var names=Object.keys(v).slice(0,40);for(var j=0;j<names.length;j++){if(keys.indexOf(names[j])>=0)continue;var other=nestedMedia(v[names[j]],depth+1);if(other)return other}return""}
function megaSource(raw){var data=parsed(raw);if(!data||typeof data!=="object")return"";var hit=nestedMedia(data,0);if(hit)return hit;try{if(typeof _jsonUrls==="function"){var urls=_jsonUrls(data)||[];for(var i=0;i<urls.length;i++){var u=mediaValue(urls[i]);if(u)return u}}}catch(_e){}return""}
async function resolveMega(embed){var page=await get(embed,"https://megaplay.buzz/",false,"","https://megaplay.buzz"),m=/\bdata-id=["'](\d+)["']/i.exec(page.body),id=s(m&&m[1]);if(!id)return"";var api="https://megaplay.buzz/stream/getSources?id="+encodeURIComponent(id),meta=await get(api,page.url||embed,true,"","https://megaplay.buzz"),u=megaSource(meta.body);return /^https?:\/\//i.test(u)?u:""}
async function playable(url){if(!url)return null;if(megaLike(url)){var nativeUrl=await resolveMega(url);if(!nativeUrl)return null;var ql=quality(nativeUrl),row={name:c.name,title:c.name,url:nativeUrl,provider:c.provider,headers:mediaHeaders()};if(ql)row.quality=ql;return row}var ql2=quality(url),row2={name:c.name,title:c.name,url:url,provider:c.provider,headers:{Referer:"https://megaplay.buzz/",Origin:"https://megaplay.buzz","User-Agent":ua()}};if(ql2)row2.quality=ql2;return row2}
async function resolveOn(base,meta){var search=base+"/search?keyword="+encodeURIComponent(meta.title),page=await get(search,base+"/",false,"",""),cands=results(page.body,meta);for(var i=0;i<cands.length;i++){var slug=cands[i].slug;try{var watch=await get(base+"/watch/"+encodeURIComponent(slug),base+"/",false,page.cookie,""),aid=animeId(watch.body);if(!aid)continue;var epsResp=await get(base+"/ajax/episode/list/"+encodeURIComponent(aid),watch.url,true,watch.cookie||page.cookie,""),episodes=episodeRows(epsResp.body);if(!episodes.length)continue;var wanted=meta.type==="movie"?episodes[0]:episodes.find(function(e){return Number(e.num)===Number(meta.episode)})||episodes[meta.episode-1];if(!wanted)continue;var ids=s(wanted.ids||wanted.id);if(!ids)continue;var servers=await get(base+"/ajax/server/list?servers="+encodeURIComponent(ids),watch.url,true,watch.cookie||page.cookie,""),links=serverLinks(servers.body);for(var j=0;j<links.length&&j<6;j++){try{var st=await get(base+"/ajax/server?get="+encodeURIComponent(links[j]),watch.url,true,watch.cookie||page.cookie,""),u=streamUrl(st.body);if(!u)continue;var row=await playable(u);if(row)return[row]}catch(_e){}}}catch(_e){}}return[]}
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:7ba44c0f9a85 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:8f839f6012ff */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
  ...
  var ok=false;try{if(typeof module!=="undefined"&&module.exports)ok=install(module.exports,"getStreams")}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","capabilityStrategy":"mixed_embed_resolver","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi8J-TuiIsInByb3ZpZGVySWQiOiJhbmlrb3RvdHYiLCJwcm92aWRlck5hbWUiOiJBbmlrb3RvVFYifQ== */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:628123a8e399 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","providerName":"AnikotoTV","providerEmoji":"📺","implementationRevision":"post-safety-uniform-final-label-v10"});
