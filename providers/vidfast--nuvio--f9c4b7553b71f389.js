...
/* FIXDATA:PROVIDER.VIDFAST.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"⚡ VidFast","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://vidfast.to","modelSchemaVersion":4,"observedUrls":["https://vidfast.vc/","https://enc-dec.app/api","https://vidfast.to"],"officialApi":null,"officialHub":null,"officialSite":"https://vidfast.to","origins":["https://vidfast.to","https://vidfast.vc","https://enc-dec.app"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":["https://vidfast.to","https://vidfast.vc"],"proofProtectedHosts":[],"proofSearchBases":["https://vidfast.to","https://vidfast.vc"],"providerId":"vidfast","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/movie/{tmdbId}/","/tv/{tmdbId}/{season}/{episode}/"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-html-embed","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.VIDFAST.CONFIG.V1 */
/* STARTFIX:PROVIDER.VIDFAST.RUNTIME.V1 */
/* FIXDATA:PROVIDER.VIDFAST.RUNTIME.V1: */
...
function unescapeJsonString(v){var input=String(v||""),out="",slash=String.fromCharCode(92);for(var i=0;i<input.length;i++){var ch=input.charAt(i);if(ch!==slash||i+1>=input.length){out+=ch;continue}var n=input.charAt(++i),hex;if(n==="n"){out+="\n";continue}if(n==="r"){out+="\r";continue}if(n==="t"){out+="\t";continue}if(n==="b"){out+="\b";continue}if(n==="f"){out+="\f";continue}if(n==="v"){out+="\v";continue}if(n==="0"){out+="\0";continue}if(n==="x"&&/^[0-9a-fA-F]{2}$/.test(hex=input.slice(i+1,i+3))){out+=String.fromCharCode(parseInt(hex,16));i+=2;continue}if(n==="u"&&/^[0-9a-fA-F]{4}$/.test(hex=input.slice(i+1,i+5))){out+=String.fromCharCode(parseInt(hex,16));i+=4;continue}if(n===slash||n==='"'||n==="'"||n==="/"){out+=n;continue}out+=slash+n}return out}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"bases":[{"base":"https://vidfast.to","movie":"/embed/movie/{id}","tv":"/embed/tv/{id}/{season}/{episode}"},{"base":"https://vidfast.vc","movie":"/movie/{id}/","tv":"/tv/{id}/{season}/{episode}/"}],"decrypt":"https://enc-dec.app/api","maxStreams":8,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/145.0.0.0 Safari/537.36"});
/* CLOSEFIX:PROVIDER.VIDFAST.RUNTIME.V1 */
/* NUVIO_GLOBAL_CORE_START_BOUNDARY_V1 */
/* STARTFIX:CORE.CATALOGUE_ALIAS_RECOVERY.V2 */
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:851623e829ff */
;(function(g,c){"use strict";
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:659092113ecd */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vidfast","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-technical-badges-v29"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:6554f44024cc */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vidfast","capabilityStrategy":"iframe_player","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"minVodDurationSeconds":60,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v10-short-vod-and-correlated-player"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */

/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1zYWZldHktdW5pZm9ybS1maW5hbC1sYWJlbC12MTAiLCJwcm92aWRlckVtb2ppIjoi4pqhIiwicHJvdmlkZXJJZCI6InZpZGZhc3QiLCJwcm92aWRlck5hbWUiOiJWaWRGYXN0In0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:7c5c402c39c8 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vidfast","providerName":"VidFast","providerEmoji":"⚡","implementationRevision":"post-safety-uniform-final-label-v10"});
