...
/* FIXDATA:PROVIDER.VIXSRC.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🔌 VixSrc","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://komiknostalgia.id","modelSchemaVersion":4,"observedUrls":["https://komiknostalgia.id/","https://komiknostalgia.id"],"officialApi":null,"officialHub":null,"officialSite":"https://komiknostalgia.id","origins":["https://komiknostalgia.id"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"vixsrc","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":["/api/tv/","/movie/","/season/","/episode/","/api/movie/","/tv/","/proxy-agent.js","/api/readable.js","/api/api-request.js","/api/abort-signal.js","/api/api-stream.js","/api/api-pipeline.js","/api/api-upgrade.js","/api/api-connect.js","/api/index.js","/stream/websocketerror.js","/stream/websocketstream.js","/playlist"],"runtimeDiscovery":false,"runtimeRole":"reader","sourceRuntimeFamily":"tmdb-direct-api","strategy":"quarantined","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.VIXSRC.CONFIG.V1 */
/* NUVIO_GLOBAL_CORE_START_BOUNDARY_V1 */
/* STARTFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4:eyJjYXBhYmlsaXR5U3RyYXRlZ3kiOiJxdWFyYW50aW5lZCIsImNvbGxpc2lvbkZpeHR1cmVzIjp7IjI1OTU0NCI6eyJhbGlhc2VzIjpbIkhlbGwgVGVhY2hlcjogSmlnb2t1IFNlbnNlaSBOdWJlIiwiSmlnb2t1IFNlbnNlaSBOdWJlIiwiSGVsbCBUZWFjaGVyIE51YmUiLCLlnLDnjYTlhYjnlJ_ */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:712632d14646 */
;(function(g,c){
"use strict";
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoiY3Jvc3MtY2xpZW50LXNoYXJlZC10bWRiLWNhY2hlLWxhenktZXBpc29kZS12NyIsInByb3ZpZGVySWQiOiJ2aXhzcmMiLCJ0bWRiUnVudGltZUtleVJlcXVpcmVkIjp0cnVlLCJ0bWRiVGltZW91dE1zIjoxMjAwfQ== */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:25b4b1ff7fc3 */
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vixsrc","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-cache-lazy-episode-v7"});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:c832f9fcc012 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vixsrc","providerLanguageMode":"vo","languageFallback":"VO","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbmFtZS10aXRsZS1xdWFsaXR5LXY2IiwicHJvdmlkZXJFbW9qaSI6IvCflIwiLCJwcm92aWRlcklkIjoidml4c3JjIiwicHJvdmlkZXJOYW1lIjoiVml4U3JjIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:aec735623645 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"vixsrc","providerName":"VixSrc","providerEmoji":"🔌","implementationRevision":"post-presentation-name-title-quality-v6"});
