...
/* FIXDATA:PROVIDER.ANIMETSU.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"⚡ Animetsu","domainSubstitutions":{},"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":null,"modelSchemaVersion":4,"observedUrls":[],"officialApi":null,"officialHub":null,"officialSite":null,"origins":[],"outputLanguageRules":[],"outputUrlHostRewrites":[],"providerId":"animetsu","reconstructionState":"learning-clean-seed","routePlanVersion":3,"routes":[],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"direct_media","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:af3119c569b8 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"animetsu","providerLanguageMode":"vo","languageFallback":"VO","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-shared-tmdb-cache-native-zero-extra-fetch-v17-jvm-json-utf8"});
