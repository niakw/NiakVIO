...
assert "scoped-playback-context-v5-opaque-media" in patched
assert '"dropResolvedOriginal":true' in patched
...
# A filename-proven direct media row must remain untouched and must not trigger
# a second probe, preserving one-shot/signed direct URLs for the real player.
direct = rows[1]
