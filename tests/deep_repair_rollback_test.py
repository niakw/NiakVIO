...
EXPECTED = {
    'anime-ultime': ('providers/anime-ultime--gowaru--667e5fba43cdd884.js', '667e5fba43cdd8840b4625ce13ae71cd2d4bdea3d668297a5a845c21b0e0399f'),
    'dulourd': ('providers/dulourd--gowaru--e62064b45a10a505.js', 'e62064b45a10a505612be560f20cbd39ad34be7fa69c4fcafe51d9714f72aa05'),
    'waveanime': ('providers/waveanime--gowaru--1a87a44dbbfb3bc6.js', '1a87a44dbbfb3bc6e7757c401eb0730e994f8661a8cc3b77741c3b36ba522c90'),
    'wookafr': ('providers/wookafr--gowaru--ccd4f619dc1f34dd.js', 'ccd4f619dc1f34dd834b497fd643a8c5cf28888c268a4f6f9e1cceb5789135b1'),
}
OLD = {
...
for provider_id, (relative, digest) in EXPECTED.items():
    target = ROOT / relative
    assert target.is_file(), relative
    assert hashlib.sha256(target.read_bytes()).hexdigest() == digest
    assert MARKER not in target.read_text(encoding='utf-8', errors='strict')
    assert entries[provider_id]['filename'] == relative
