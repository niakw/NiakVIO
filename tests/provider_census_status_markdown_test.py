...
rows = {row["provider"]: row for row in build_status_rows(report, history, baseline, candidate_evidence)}
...
md = render(report, run_id="123", sha="abcdef0123456789", history=history, baseline=baseline, candidate_evidence=candidate_evidence)
