...
# Historical proof debt may be represented as audited route debt. A current provider-folder identity can remain visible while routeDataState=repair/off;
# disabled-retained identities remain visible but disabled. Neither case may hide semantic/HLS contract deletion.
for token in (
...
assert '"activationAuthority": "provider-folder-lifecycle"' in finalizer
