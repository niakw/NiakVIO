...
for needle in (
    ...
    "async function settlePrior(promise)",
...
(async()=>{
  ...
  console.log("V29_FUNCTIONAL_ABORT_RACE_OK",elapsed,JSON.stringify(calls));
...
print("v29 functional abort-race contract passed")
