...
SCRIPT = ROOT / "scripts" / "register_voiranime_homes_dle_runtime_v1.py"
spec = importlib.util.spec_from_file_location("register_voiranime_homes_dle_runtime_v1", SCRIPT)
...
row = data["provider_patches"]["voiranime-homes"]
...
print("voiranime-homes isolated DLE registration test passed")
