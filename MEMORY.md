...
- A generic publication bug was confirmed: provider publication fingerprint schema v3 did not include shared Core Lego source files, so a changed shared Core could pass tests while existing provider bytes remained stale. Commit `1cae0e2c4d2b7defa102875b6538ce942c503f90` moved the publication contract to schema v4 and hashes shared Core publication files plus globally referenced patch scripts. The projection drift fixture was aligned in `b8cc9782462c3af8457888807f484cb8b95bb5a0`.
