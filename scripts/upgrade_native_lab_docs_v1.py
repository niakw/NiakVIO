...
def main() -> int:
    ...
    en_block = (
        ...
        "The maintained catalogue remains **96 Provider Objects**. Final native acceptance uses the "
        "explicit physical **Hub-46** scope from `automation/evidence/hub-lab-matrix-46.json`; disabled "
        "or out-of-scope catalogue rows remain visible maintenance debt and are not silently deleted.\n\n"
    ...
    fr_block = (
        ...
        "Le catalogue maintenu reste **96 Provider Objects**. L’acceptation native finale utilise le "
        ...
        "supprimées artificiellement du catalogue.\n\n"
    ...
    coverage_new = (
        "Le catalogue reste **96 providers**. La campagne d’acceptation native finale utilise actuellement "
        ...
        "restent séparées du dénominateur physique du Lab. Le nombre de routes est calculé depuis le scope "
