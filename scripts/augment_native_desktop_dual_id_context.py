...
# Temporary compatibility marker consumed only by the one-shot V2 A/B workflow.
# It is not the active bridge version and can disappear with that workflow.
WORKFLOW_COMPAT_MARKER = "NIAKVIO_LAB_DUAL_ID_CONTEXT_V2"
