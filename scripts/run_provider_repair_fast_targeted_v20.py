#!/usr/bin/env python3
"""Run canonical targeted repair with V20 immediately before live recovery."""
...
def _run_with_v20_boundary(*args: str, timeout: int | None = None) -> None:
    global _v20_applied
    # Preserve the complete legacy migration sequence unchanged. V20 patches all
    # five owners only after V1-V19 have established their final anchors and just
    # before the first upstream census consumes provider responses.
