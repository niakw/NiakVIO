...
def main() -> int:
    ...
    for source in source_rows:
        ...
        if repo_opaque:
            ...
            if not (route_kinds & EXEC_ROUTE_KINDS) and not search_plan and not value_plan and not external_identity_plan:
