...
MARKER = "## 2026-09-07 — Route recognition V6 retry/dependency checkpoint"
BLOCK = r'''
...
def main() -> int:
    ...
    if MARKER in text:
        print("MEMORY_ROUTE_REPAIR_CHECKPOINT already-present")
        return 0
    PATH.write_text(text.rstrip() + BLOCK + "\n", encoding="utf-8")
    print("MEMORY_ROUTE_REPAIR_CHECKPOINT appended")
    return 0
