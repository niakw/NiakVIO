...
def finalize_provider(
    ...
    if completion_state in {"terminal-blocked", "terminal-unreachable", "disabled-unqualified", "resample-required"}:
    ...
    blocked_recipe_plan = completion_state in {"terminal-blocked", "terminal-unreachable", "disabled-unqualified", "resample-required"}
    ...
    model["routeRecognition"] = {
        ...
        "executionPlanRetainsAttemptedNon2xx": completion_state in {"terminal-blocked", "terminal-unreachable", "disabled-unqualified", "resample-required"},
        "executionPlanRetainsFailedLive": False,
        "blockedNon2xxPlanPreserved": completion_state in {"terminal-blocked", "terminal-unreachable", "disabled-unqualified", "resample-required"},
        ...
        "blockedPlanPreserved": completion_state in {"terminal-blocked", "terminal-unreachable", "disabled-unqualified", "resample-required"},
    ...
    if isinstance(patch, dict):
        ...
        patch["live_route_gate"] = {
            ...
            "blocked_plan_preserved": completion_state in {"terminal-blocked", "terminal-unreachable", "disabled-unqualified", "resample-required"},
