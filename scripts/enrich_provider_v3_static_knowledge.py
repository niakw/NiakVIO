...
the normalization guard, role classifier and expression analyzer extend it with
safe static understanding of route purpose, URL concatenation, request variables,
POST bodies and bounded decoded string evidence. No provider JavaScript is
executed.
"""
import provider_contract_recognizer as _recognizer
from provider_route_normalization_guard import install as _install_route_guard
...
_install_route_guard(_recognizer)
