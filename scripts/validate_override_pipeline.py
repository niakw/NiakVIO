...
def main() -> int:
    ...
    for candidate in candidates:
        ...
        for old, new in replacements.items():
            ...
            # Only demand a replacement record when the upstream file actually
            # contained the old value. The upstream and patched hashes reveal it.
            matching_records = [
