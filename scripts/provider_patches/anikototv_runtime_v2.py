...
function h(ref,xhr,cookie){var out={"User-Agent":c.userAgent,"Accept":"text/html,application/json,text/plain,*/*"};if(ref)out.Referer=ref;if(xhr)out["X-Requested-With"]="XMLHttpRequest";if(cookie)out.Cookie=cookie;return out}
