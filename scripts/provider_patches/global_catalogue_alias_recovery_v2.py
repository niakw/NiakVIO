...
def apply(text: str, options: dict[str, Any] | None = None, **_kwargs: Any) -> str:
    ...
    payload = {
        ...
        "directPaths": [str(v) for v in cfg.get("direct_paths", []) if str(v).strip()],
        ...
        "authoritative": bool(cfg.get("authoritative", False)),
        "implementationRevision": "authoritative-recovery-v10-episode-attributes",
    }
