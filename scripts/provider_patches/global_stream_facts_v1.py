...
STREAM_FACTS therefore preserves provider-owned originals first so presentation is
lossless at the structured-data boundary. Normalized facts remain available under their
canonical fields while precise provider values survive under stable source* fields.
"""
