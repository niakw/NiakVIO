...
def apply(text: str, options: dict[str, Any] | None = None, **_kwargs: Any) -> str:
    return apply_runtime(text, managed_fix_id=MANAGED_FIX_ID, marker=MARKER, defaults={"base":"https://manifest.desitvhub.eu.org","provider":"desiflix","name":"DesiFlix"}, options=options)
