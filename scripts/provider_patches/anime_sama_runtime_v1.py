...
player URL). It does not embed or execute upstream JavaScript. The provider Lego
registers through Core Provider Runtime Dispatch V1 so Core retains final stream
ownership and later Core wrappers cannot silently replace the Anime-Sama route.
"""
