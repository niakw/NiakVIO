...
def apply(text: str, options: dict[str, Any] | None = None, **kwargs: Any) -> str:
    ...
    config = {
        ...
        "minVodDurationSeconds": max(15, min(int(raw_options.get("min_vod_duration_seconds") or 60), 600)),
        "durationIdentity": bool(raw_options.get("duration_identity", True)),
        "strictPlayback": bool(raw_options.get("strict_playback", False)),
        "implementationRevision": "field-safety-v10-short-vod-and-correlated-player",
    }
