...
SEARCH_ITEM_MARKER = "NIAKVIO_FRENCH_MANGA_SEARCH_ITEM_V2"


def _french_manga_wrapper() -> str:
    """Extend the shared DLE parser with French-Manga's live AJAX card shape.

    Current French-Manga search results are div.search-item nodes whose target is
...
def apply(text: str, options: dict[str, Any] | None = None, **_kwargs: Any) -> str:
    ...
    wrapper = _french_manga_wrapper().replace("CONFIG_PLACEHOLDER", json.dumps(payload, ensure_ascii=False, separators=(",", ":")))
