...
MARKER = "NIAKVIO_VOIRANIME_ANIME_RUNTIME_V5_MULTI_SERIES_FALLBACK"
...
def apply(text: str, options: dict[str, Any] | None = None, **_kwargs: Any) -> str:
    ...
    return replace_managed_fix(
        ...
        js.lstrip(),
        data={
            "runtimeFamily": "voiranime-current-site-anime-v5-multi-series-fallback",
            "scope": "anime-plus-delegate-previous",
            "identity": "core-tmdb-title-season-episode",
            "catalogue": "multi-variant-direct-slug-plus-wordpress-search",
