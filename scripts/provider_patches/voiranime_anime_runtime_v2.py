...
MARKER = "NIAKVIO_VOIRANIME_ANIME_RUNTIME_V4_CANONICAL_EPISODE_HOSTS"

WRAPPER = r'''
/* NIAKVIO_VOIRANIME_ANIME_RUNTIME_V4_CANONICAL_EPISODE_HOSTS */
...
def apply(text: str, options: dict[str, Any] | None = None, **_kwargs: Any) -> str:
    ...
    return replace_managed_fix(
        ...
        js.lstrip(),
        data={
            "runtimeFamily": "voiranime-current-site-anime-v4-canonical-episode-hosts",
