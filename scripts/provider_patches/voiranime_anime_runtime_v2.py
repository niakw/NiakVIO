...
MARKER = "NIAKVIO_VOIRANIME_ANIME_RUNTIME_V3_EPISODE_LINKS"

WRAPPER = r'''
/* NIAKVIO_VOIRANIME_ANIME_RUNTIME_V3_EPISODE_LINKS */
...
def apply(text: str, options: dict[str, Any] | None = None, **_kwargs: Any) -> str:
    ...
    return replace_managed_fix(
        ...
        js.lstrip(),
        data={
            "runtimeFamily": "voiranime-current-site-anime-v3-episode-links",
