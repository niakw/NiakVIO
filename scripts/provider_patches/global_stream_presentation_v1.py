...
def apply(text: str, options: dict[str, Any] | None = None, **kwargs: Any) -> str:
    ...
    payload = {
        ...
        "implementationRevision": "all-providers-forced-description-badge-emoji-tmdb-v11",
    }
