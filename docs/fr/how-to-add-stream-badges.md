...
> [!TIP]
> Pour la majorité des utilisateurs, **Fusion v8** est le bon feed.
...
- Dark v8 : `https://raw.githubusercontent.com/niakw/NiakVIO/main/assets/stream-badges-dark-v8.json`
- Light v8 : `https://raw.githubusercontent.com/niakw/NiakVIO/main/assets/stream-badges-light-v8.json`
- Transparent v8 : `https://raw.githubusercontent.com/niakw/NiakVIO/main/assets/stream-badges-transparent-v8.json`

Utilisez-les uniquement si vous recherchez explicitement une variante liée au thème ; **Fusion v8 reste la configuration normale**.
...
5. Collez l'URL JSON Fusion v8 de NiakVIO.
...
7. Dans la page web ouverte sur votre téléphone, collez l'URL JSON Fusion v8 de NiakVIO.
...
> [!IMPORTANT]
> La TV conserve localement les règles déjà importées. Si une ancienne version du feed Fusion NiakVIO ne se met pas correctement à jour, supprimez l'ancien import puis ajoutez à nouveau l'URL **Fusion v8** actuelle.
...
- réimportez l'URL Fusion v8 actuelle ;
...
- `assets/stream-badges-fusion-v8.json` — feed recommandé multi-thème ;
- `assets/stream-badges-dark-v8.json` — fonds d'application sombres ;
- `assets/stream-badges-light-v8.json` — fonds d'application clairs ;
- `assets/stream-badges-transparent-v8.json` — artwork transparent.
