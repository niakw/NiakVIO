...
Les fixtures historiques de `.github/triggers/nuvio-client-lab.json` restent disponibles pour les diagnostics de régression ciblés, mais ne sont plus l’autorité d’échantillonnage global ordinaire.
