...
8. Quick/Deep ne réparent ni ne reconstruisent.
9. Learning ne publie pas directement.
10. Domain Refresh reste CONFIG `official_site`-only.
11. Les cinq Labs restent séparés et observationnels.
12. Aucun Lab ne corrige un bug du repo Nuvio pour obtenir un vert.
13. Mauvais média jouable = échec.
14. Stream cassé ≠ provider globalement désactivé.
15. Terser interdit ; minimizer conservateur uniquement.
16. HTML stripping générique par regexp interdit.
17. Les métriques/run IDs historiques restent dans les rapports, pas dans les invariants.
