...
/* NUVIO_VF_CATALOGUE_RECOVERY_V1:5cd631aec52e */
;(function(g,config){
  "use strict";
...
})(typeof globalThis!=="undefined"?globalThis:this,{"implementationVersion":3,"strategy":"api_fixed","baseUrl":"https://movix.fun","apiUrl":"https://api.movix.fun","types":["movie","tv","anime"],"searchPaths":[],"directPaths":[],"apiRoutes":["/api/catalog/movie/{id}","/api/catalog/tv/{id}/season/{season}"],"blockedHosts":["fstream.top"],"blockedPathPatterns":[],"preferredPlayerGroups":["VFF","VFQ","VF","Default","VOSTFR"],"maxPlayers":10,"timeoutMs":7000,"providerName":"Movix","recoveryFirst":true,"skipNativeWhenUnresolved":true});
