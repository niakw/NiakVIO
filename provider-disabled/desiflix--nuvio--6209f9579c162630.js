...
/* FIXDATA:PROVIDER.DESIFLIX.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🇮🇳 DesiFlix","domainSubstitutions":{"desiflix.onl":"desiflix.codes"},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"tmdb_direct","requiredFields":["tmdbId","mediaType"],"requiresTmdbBeforeRun":false},"knownSite":"https://desiflix.codes","modelSchemaVersion":4,"observedUrls":["https://desiflix.codes/","https://desiflix.codes","https://manifest.desitvhub.eu.org"],"officialApi":"https://manifest.desitvhub.eu.org","officialHub":"https://desiflix.me","officialSite":"https://desiflix.codes","origins":["https://desiflix.codes","https://manifest.desitvhub.eu.org"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"desiflix","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/stream/movie/{id}.json","/stream/series/{id}:{season}:{episode}.json"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"stremio-json","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.DESIFLIX.CONFIG.V1 */
/* STARTFIX:PROVIDER.DESIFLIX.RUNTIME.V1 */
/* FIXDATA:PROVIDER.DESIFLIX.RUNTIME.V1: */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"base":"https://desiflix.stremioaddon.workers.dev","fallbackBases":["https://manifest.desitvhub.eu.org"],"provider":"desiflix","name":"DesiFlix","userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 NiakVIO/3"});
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:9dd952d728f9 */
;(function(g,c){
"use strict";
function s(v){return String(v==null?"":v).trim()}
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:9b7bfc268ae2 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"desiflix","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-strongest-evidence-v22"});
