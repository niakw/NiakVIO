...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"authoring":"niakvio-owned-v2","displayName":"HiAnime","fixedApi":null,"knownSite":null,"observedUrls":[],"officialApi":null,"officialHub":null,"officialSite":null,"origins":["https://old.invalid","https://www.themoviedb.org"],"providerId":"hianime","reconstructionState":"learning-clean-seed","routePlanVersion":1,"routes":[],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"html_scraper","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
