...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"authoring":"niakvio-owned-v2","displayName":"Flemmix","fixedApi":null,"knownSite":"https://flemmix.men","observedUrls":["https://video/","https://${/","https://vidmoly.to/","https://${g}/","https://my.mail.ru/+/video/meta/${i}","https://my.mail.ru/","https://${a}${n}/","https://${a}/","https://${n}/","https://f/","https://vidzy.live/","https://${i}/pa","https://${i}/","https://www.myvi.ru/","https://www.myvi.ru/api/video/${a[1]}","https://younetu.org/","https://vidoza.net/","https://lecteurvideo.com/","https://wookafr.center/","https://up4fun.top/","https://flemmix.men/","https://npm/","https://kit/","https://arm.haglund.dev/api/v2","https://v3-cinemeta/","https://loda/","https://openj/","http://under/"],"officialApi":null,"officialHub":"https://flemmix.men/","officialSite":"https://flemmix.men","origins":["https://video.sibnet.ru","https://vidmoly.me","https://streamtape.com","https://sendvid.com","https://www.myvi.ru","https://younetu.org","https://vidoza.net","https://lecteurvideo.com","https://up4fun.top","https://ww547.wiflix-hd.vip","https://npms.io","https://kitsu.io","https://arm.haglund.dev","https://v3-cinemeta.strem.io","https://lodash.com","https://openjsf.org","http://underscorejs.org","https://flemmix.men","https://old.invalid","https://www.themoviedb.org","https://video","https://${","https://vidmoly.to","https://${g}"],"providerId":"flemmix","reconstructionState":"learning-clean-seed","routePlanVersion":1,"routes":["/","/+/video/meta/${i}","/pa","/api/video/${a[1]}","/api/v2"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"mixed_embed_resolver","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* NUVIO_VF_CATALOGUE_RECOVERY_V1:1e11a8949263 */
;(function(g,config){
  "use strict";
...
})(typeof globalThis!=="undefined"?globalThis:this,{"implementationVersion":3,"strategy":"html","baseUrl":"http://ww547.wiflix-hd.vip","apiUrl":"","types":["movie"],"searchPaths":["/index.php?do=search&subaction=search&story={query}","/?do=search&subaction=search&story={query}","/?s={query}","/search?q={query}"],"directPaths":["/{slug}","/film/{slug}","/films/{slug}"],"apiRoutes":[],"blockedHosts":["fstream.top"],"blockedPathPatterns":[],"preferredPlayerGroups":["VFF","VFQ","VF","Default","VOSTFR"],"maxPlayers":8,"timeoutMs":7000,"providerName":"Flemmix","recoveryFirst":true,"skipNativeWhenUnresolved":false});
