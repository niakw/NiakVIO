...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"authoring":"niakvio-owned-v2","displayName":"🏰 Castle","fixedApi":null,"knownSite":"https://api.hlowb.com","observedUrls":["https://api.hlowb.com/"],"officialApi":null,"officialHub":null,"officialSite":null,"origins":["https://api.hlowb.com","https://old.invalid","https://www.themoviedb.org"],"providerId":"castle","reconstructionState":"learning-clean-seed","routePlanVersion":1,"routes":["/"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"api_stream_resolver","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
