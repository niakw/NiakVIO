...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"authoring":"niakvio-owned-v2","displayName":"Frenchstream","fixedApi":null,"knownSite":"https://fs16.lol","observedUrls":["https://npm/","https://video/","https://${/","https://vidmoly.to/","https://${m}/","https://my.mail.ru/+/video/meta/${i}","https://my.mail.ru/","https://${v}${n}/","https://${v}/","https://${n}/","https://f/","https://vidzy.live/","https://${i}/pa","https://${i}/","https://www.myvi.ru/","https://www.myvi.ru/api/video/${a[1]}","https://younetu.org/","https://vidoza.net/","https://lecteurvideo.com/","https://wookafr.center/","https://${a}/","https://up4fun.top/","https://arm.haglund.dev/api/v2","https://v3-cinemeta/","https://kit/","https://french-/","https://loda/","https://openj/","http://under/"],"officialApi":null,"officialHub":"https://fstream.org/","officialSite":"https://fs16.lol","origins":["https://old.invalid","https://www.themoviedb.org","https://npm","https://video","https://${","https://vidmoly.to","https://${m}","https://my.mail.ru","https://${v}${n}","https://${v}","https://${n}","https://f","https://vidzy.live","https://${i}","https://www.myvi.ru","https://younetu.org","https://vidoza.net","https://lecteurvideo.com","https://wookafr.center","https://${a}","https://up4fun.top","https://arm.haglund.dev","https://v3-cinemeta","https://kit"],"providerId":"frenchstream","reconstructionState":"learning-clean-seed","routePlanVersion":1,"routes":["/","/+/video/meta/${i}","/pa","/api/video/${a[1]}","/api/v2"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"quarantined","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
...
/* NUVIO_FRENCHSTREAM_DLE_CATALOGUE_V1:5aecf932f795 */
...
async function meta(q){var title=s(q.title||q.name||q.label).replace(/\s*\(\d{4}\)\s*$/,"");var year=Number(q.year)||0;if(!title&&q.tmdbId&&TMDB_KEY){var type=q.mediaType==="tv"?"tv":"movie",r=await request("https://api.themoviedb.org/3/"+type+"/"+encodeURIComponent(q.tmdbId)+"?api_key="+TMDB_KEY+"&language=fr-FR","json");if(r&&r.body){title=s(r.body.title||r.body.name);year=Number(s(r.body.release_date||r.body.first_air_date).slice(0,4))||year}}return {title:title,year:year}}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"hubUrl":"https://www.fstream.org/","fallbackBase":"https://fs16.lol","providerName":"Frenchstream"});
...
/* NUVIO_TV_TARGET_MEDIA_V3:9248c470ea65 */
;(function(g,c){"use strict";
...
function rejected(u){var h=hostname(u);if(!h||ASSET.test(u)||SOCIAL.test(h)||DEMO.test(u)||/\/troll\/master\.m3u8(?:[?#]|$)/i.test(u)||/\/(?:static\/hero(?:[-_][^/?#]*)?\.(?:mp4|webm|avif)|cdn-cgi\/challenge-platform)(?:[?#]|$)/i.test(u)||/%7b|%7d|decodedlink|\$\{|encodeURIComponent\(|credentials:/i.test(u))return true;var blocked=["analytics.google.com","api.themoviedb.org","arm.haglund.dev","cloudflare.com","cloudflareinsights.com","connect.facebook.net","ctfassets.net","doubleclick.net","fstream.top","google-analytics.com","googlesyndication.com","googletagmanager.com","graphql.anilist.co","pagead2.googlesyndication.com","s1.fsvid.lol","sc-cdn.net","snap.com","snapchat.com","static.cloudflareinsights.com","v3-cinemeta.strem.io"];for(var bi=0;bi<blocked.length;bi++){var rule=blocked[bi];if(h===rule||h.endsWith('.'+rule))return true}return false}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerName":"Frenchstream","maxDepth":5,"maxCandidates":22,"timeoutMs":20000});
/* NUVIO_TV_TEXT_ONLY_FETCH_COMPAT_V1 */
/* NUVIO_TV_PROTOCOL_RELATIVE_URL_COMPAT_V1 */
/* NUVIO_EXPOSE_STRICT_WRAPPER_ORIGINAL_V1 */
/* NUVIO_TARGET_MEDIA_HOST_FILTER_V4:a4c0437402d7 */
;(function(g,c){"use strict";
...
/* NUVIO_VF_CATALOGUE_RECOVERY_V1:7a8970563b40 */
;(function(g,config){
  "use strict";
  var TMDB_KEY=(g&&g.TMDB_API_KEY)||"";
...
})(typeof globalThis!=="undefined"?globalThis:this,{"implementationVersion":3,"strategy":"html","baseUrl":"https://fs16.lol","apiUrl":"","types":["movie","tv","anime"],"searchPaths":["/index.php?do=search&subaction=search&story={query}","/?do=search&subaction=search&story={query}","/?s={query}"],"directPaths":[],"apiRoutes":[],"blockedHosts":["fstream.top"],"blockedPathPatterns":[],"preferredPlayerGroups":["VFF","VFQ","VF","Default","VOSTFR"],"maxPlayers":8,"timeoutMs":7000,"providerName":"Frenchstream","recoveryFirst":true,"skipNativeWhenUnresolved":false});
