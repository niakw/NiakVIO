...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"authoring":"niakvio-owned-v2","displayName":"HindMoviez","fixedApi":null,"knownSite":"https://hindmovie.fit","observedUrls":["https://mvlink.blog/wp-admin/admin-ajax.php"],"officialApi":null,"officialHub":"https://t.me/s/hindmoviez/1975","officialSite":"https://hindmovie.fit","origins":["https://mvlink.blog","https://old.invalid","https://www.themoviedb.org","https://hindmovie.fit"],"providerId":"hindmoviez","reconstructionState":"learning-clean-seed","routePlanVersion":1,"routes":["/?s={query}","/search?q={query}","/index.php?do=search&subaction=search&story={query}","/{slug}","/film/{slug}","/films/{slug}","/anime/{slug}","/serie/{slug}","/series/{slug}","/wp-admin/admin-ajax.php"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"direct_media","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
