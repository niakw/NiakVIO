...
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"authoring":"niakvio-owned-v2","displayName":"Purstream","fixedApi":"https://api.purstream.id/api/v1","knownSite":"https://purstream.id","observedUrls":["https://raw.githubu/","https://api.pur/","https://pur/"],"officialApi":"https://api.purstream.id/api/v1","officialHub":"https://purstream.wiki","officialSite":"https://purstream.id","origins":["https://purstream.wiki","https://api.purstream","https://api.purstream.id","https://purstream.id","https://old.invalid","https://www.themoviedb.org","https://raw.githubu","https://api.pur","https://pur"],"providerId":"purstream","reconstructionState":"learning-clean-seed","routePlanVersion":1,"routes":["/"],"runtimeDiscovery":false,"runtimeRole":"reader","strategy":"official_domain_hub","supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
