...
var MAIN_URL = "https://mycima.chat";
var HEADERS = {
...
function loadExtractor(url) {
  return __async(this, null, function* () {
    try {
      ...
      if (domain.includes("vidstack") || domain.includes("hubstream") || domain.includes("bigwarp") || domain.includes("mxdrop") || domain.includes("wasuytm") || __nuvioHostMatches(domain,"upn.one") || __nuvioHostMatches(domain,"server1.uns") || __nuvioHostMatches(domain,"kumi.uns")) {
